...
- Reduced the size of cache files, making old cache files incompatible with the new version
...
- Clean and safe scan cancellation - [#1183](https://github.com/qarmin/czkawka/pull/1183)
...
- Collecting files for scan can be a lot faster due to lazy file metadata gathering - [#1152](https://github.com/qarmin/czkawka/pull/1152)
...
- Decrease a little size of cache by a few percent and improve loading/saving speed - [#1159](https://github.com/qarmin/czkawka/pull/1159)
...
- BREAKING CHANGE - Changed cache saving method, deduplicated, optimized and simplified procedure (all files need to be hashed again) - [#1072](https://github.com/qarmin/czkawka/pull/1072), [#1086](https://github.com/qarmin/czkawka/pull/1086)
...
- Use fun_time library to print how much time functions take - [#1082](https://github.com/qarmin/czkawka/pull/1082)
...
- Allow finding duplicates by name/size at once - [#956](https://github.com/qarmin/czkawka/pull/956)
...
- Allow setting number of threads from CLI - [#972](https://github.com/qarmin/czkawka/pull/972)
- Fix a problem with invalid item sorting in bad extensions mode - [#972](https://github.com/qarmin/czkawka/pull/972)
...
- Allow setting number of threads used to scan - [#839](https://github.com/qarmin/czkawka/pull/839)
- Faster similar images comparison with reference folders - [#826](https://github.com/qarmin/czkawka/pull/826)
- Update to clap 4 - [#878](https://github.com/qarmin/czkawka/pull/878)
- Use FileChooserNative instead of FileChooserDialog - [#894](https://github.com/qarmin/czkawka/pull/894)
- Fix invalid music tags in music files when using reference folders - [#894](https://github.com/qarmin/czkawka/pull/894)
- Updated PDF dependency (a lot less broken PDF false positives) - [#894](https://github.com/qarmin/czkawka/pull/894)
...
- Verify if hardlinking works, and if not, disable the button with proper message - [#881](https://github.com/qarmin/czkawka/pull/881)
- Apply some pydantic clippy lints on project - [#901](https://github.com/qarmin/czkawka/pull/901)

## Version 5.0.2 - 30.08.2022r

- Fixed the problem with missing some similar images when using similarity > 0 - [#799](https://github.com/qarmin/czkawka/pull/799)
...
- Similar videos stop to proceed video after a certain amount of time (fixes freezes) - [#815](https://github.com/qarmin/czkawka/pull/815)
...
- Show an error message when all directories are set as reference folders - [#795](https://github.com/qarmin/czkawka/pull/795)
...
- Fix a freeze when not choosing any tag in similar music mode - [#732](https://github.com/qarmin/czkawka/pull/732)
...
- New mode - finding files in which content doesn't match with their extension - [#678](https://github.com/qarmin/czkawka/pull/678)
...
- Fix search problem due to accumulated stop events - [#623](https://github.com/qarmin/czkawka/pull/623)
...
- Prevent from getting not responding app notification from display servers - [#625](https://github.com/qarmin/czkawka/pull/625)

## Version 4.0.0 - 20.01.2022r

- Multithreading support for collecting files to check (2/3x speedup on a 4-thread processor and SSD) - [#502](https://github.com/qarmin/czkawka/pull/502), [#504](https://github.com/qarmin/czkawka/pull/504)
- Add multiple translations - Polish, Italian, French, German, Russian … - [#469](https://github.com/qarmin/czkawka/pull/469), [#508](https://github.com/qarmin/czkawka/pull/508), [5th](https://github.com/qarmin/czkawka/commit/5be801e76395855f07ab1da43cdbb8bd0b843834)
...
- Allow caching pre-hash - [#477](https://github.com/qarmin/czkawka/pull/477)
- Improve custom selecting of records (allows using Rust regex) - [#489](https://github.com/qarmin/czkawka/pull/478)
...
- Use checkbox instead of selection to select files [#392](https://github.com/qarmin/czkawka/pull/392)
...
- Use GtkScale instead of radio buttons for similarity [#397](https://github.com/qarmin/czkawka/pull/397)
...
- Add info that Czkawka and BleachBit aren't alternatives to each other - [30602a486](https://github.com/qarmin/czkawka/commit/30602a486f6ade6f9b7b91a73708225b4f4c2a7d)
...
- Allow saving to file similar images results - [10156ccfd3](https://github.com/qarmin/czkawka/commit/10156ccfd3ba880d26d4bbad1e025b0050d7753b)
- Keep the original file if replacing duplicate with hardlink fails - [#256](https://github.com/qarmin/czkawka/pull/256)
...
- Fix included/excluded files that contain commas - [#195](https://github.com/qarmin/czkawka/pull/195)
...
- Add support for a delete button - [#159](https://github.com/qarmin/czkawka/pull/159)
- Allow selecting multiple entries in File Chooser - [#154](https://github.com/qarmin/czkawka/pull/154)
...
- Modernize popover code and simplify later changes - [#137](https://github.com/qarmin/czkawka/pull/137)
...
- Fix AppImage crash by adding a PNG version of the icon - [#126](https://github.com/qarmin/czkawka/pull/126)
- Split symlink path to two path and file name - [#127](https://github.com/qarmin/czkawka/pull/127)
- Add an option to open folders by double right click - [#128](https://github.com/qarmin/czkawka/pull/128)
...
- Multithreading Support for most modules - [#98](https://github.com/qarmin/czkawka/pull/98) [#99](https://github.com/qarmin/czkawka/pull/99) [#100](https://github.com/qarmin/czkawka/pull/100) [#101](https://github.com/qarmin/czkawka/pull/101)
...
- Add support for opening files/folders from the GUI with double-click [#70](https://github.com/qarmin/czkawka/pull/70)
...
- Added ability to stop a task from GUI [#55](https://github.com/qarmin/czkawka/pull/55)
...
- The app can be downloaded also from Arch AUR and Cargo [#36](https://github.com/qarmin/czkawka/pull/36)
...
- Support for all notebook items in GUI
...
- Changed the minimum version of GTK to 3.22
- Added a save system to GUI
- Added Big, Temporary and Empty folders finder to GUI

## Version 0.1.3 - 27.09.2020r

- Big code refactoring - now is a lot easier to create new modules and maintain old ones
- Added finding empty files
- Added a new option to find duplicates by checking hash max 1MB of file
...
- Remember the place where the button is placed
...
- Core functions don't use now process::exit(everything is done with the help of messages/errors/warnings)
