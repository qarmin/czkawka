...
rust_checked_images = Проверено { $items_stats } изображений ({ $size_stats })
...
settings_application_scale_hint_text = Ручное масштабирование (например, 1.0 = 100%)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Сгенерировать сетку миниатюр вместо одного изображения (может занять больше времени)
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Сгенерировать сетку миниатюр вместо одного изображения
settings_similar_videos_clear_unused_thumbnails = Удалить неиспользуемые видеопревью старше 7 дней при запуске приложения
...
subsettings_video_optimizer_image_threshold = Порог изображения
...
optimize_text = Оптимизировать изображения
optimize_confirmation_text = Вы уверены, что хотите оптимизировать выбранные элементы?
