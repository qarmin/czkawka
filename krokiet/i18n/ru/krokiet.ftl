...
rust_cannot_load_preset = Невозможно загрузить пресет { $preset_idx }, причина: { $reason }
...
rust_delete_summary = Удаленные { $deleted } элементы, не удалось удалить { $failed } элементы
rust_error_creating_folder = Ошибка при создании папки: { $error }
...
rust_hashed_images = Хэшированный образ { $items_stats } ({ $size_stats })
rust_compared_image_hashes = Хэш изображений по сравнению { $items_stats }
rust_hashed_videos = Хэшировано видео { $items_stats }
...
manual_add_button = Ручное добавление
...
sort_reverse = Обратный сортировка
...
subsettings_images_ignore_same_size = Игнорировать одинаковый размер
...
subsettings_videos_ignore_same_size = Игнорировать одинаковый размер
...
subsettings_music_compare_fingerprints_only_with_similar_titles = Сравнить только с похожими названиями
...
delete_confirmation = Вы уверены, что хотите удалить выбранные элементы?
