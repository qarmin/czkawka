...
rust_checked_images = Überprüft { $items_stats } Bilder ({ $size_stats })
...
included_directories = Inkludierte Verzeichnisse
...
settings_duplicate_use_prehash = Benutze Prehash
...
settings_application_scale_hint_text = Manuelle Anwendungsmaßskala (z.B. 1.0 = 100%)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Erstelle ein Raster von Vorschaubildern anstelle eines einzelnen Bildes (kann länger dauern)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Erstelle Raster-Miniaturansichten anstelle von Einzelbildern
...
settings_similar_videos_clear_unused_thumbnails = Lösche nicht verwendete Videobilder älter als 7 Tage beim App-Start.
...
subsettings_video_optimizer_image_threshold = Bildschwellwert
...
optimize_text = Optimiere Bilder
optimize_confirmation_text = Sind Sie sicher, dass Sie die ausgewählten Elemente optimieren möchten?
