...
rust_error_moving_to_trash = Fehler beim Verschieben in den Papierkorb: { $error }
rust_error_removing_file = Fehler beim Entfernen der Datei: { $error }
...
rust_compared_image_hashes = Verglichen mit { $items_stats } Bildhashes
...
rust_failed_to_rename_file = Fehler beim Umbenennen der Datei { $old_path } in { $new_path } mit Fehler { $error }
...
rust_found_empty_folders = { $items_found } leere Ordner gefunden
rust_found_empty_files = { $items_found } leere Dateien gefunden
rust_found_similar_images = Gefunden { $items_found } ähnliche Bilddateien
rust_found_similar_videos = Gefunden { $items_found } ähnliche Videodateien
rust_no_similarity_method_selected = Ähnliche Musikdateien können ohne eine ähnliche Methode nicht gefunden werden.
rust_found_similar_music_files = { $items_found } ähnliche Musikdateien gefunden
rust_found_invalid_symlinks = { $items_found } ungültige Symlinks gefunden
rust_found_temporary_files = Gefunden { $items_found } temporäre Dateien
rust_no_file_type_selected = Fehlende Dateien können nicht gefunden werden, ohne dass ein Dateityp ausgewählt wurde.
rust_found_broken_files = Gefunden { $items_found } defekte Dateien
rust_found_bad_extensions = { $items_found } Dateien mit fehlerhaften Erweiterungen gefunden
rust_found_duplicate_files = Found { $items_found } duplicate files
rust_found_big_files = { $items_found } große Dateien gefunden
...
rust_delete_summary = Gelöschte { $deleted } Elemente, Fehler beim Entfernen von { $failed } Objekten, aus allen { $total } Elementen
rust_rename_summary = Umbenannte { $renamed } Elemente, konnte { $failed } Elemente nicht umbenennen von allen { $total } Elementen
rust_move_summary = Bewegte { $moved } Elemente, konnte { $failed } Elemente nicht verschieben, von allen { $total } Elementen
...
rust_no_files_deleted = Keine Dateien/Ordner zum Löschen ausgewählt
rust_no_files_renamed = Keine Dateien/Ordner zum Umbenennen ausgewählt
rust_no_files_moved = Keine Dateien/Ordner zum Verschieben ausgewählt
rust_delete_confirmation = Sind Sie sicher, dass Sie die ausgewählten Elemente wollen?
rust_delete_confirmation_number_simple = { $items } Elemente ausgewählt.
rust_delete_confirmation_number_groups = { $items } Elemente in { $groups } Gruppen sind ausgewählt.
rust_delete_confirmation_selected_all_in_group = In { $groups } Gruppen sind alle Elemente ausgewählt.
...
are_you_want_to_continue = Möchten Sie fortfahren?
...
motto = Dieses Programm kann kostenlos verwendet werden und wird es immer sein.\nSiehe die MIT/GPL Lizenz für Details.
unicorn = Du siehst vielleicht nicht Einhorn an, aber Einhorn schaut immer auf dich.
...
sort_by_item_name = Nach Artikelnamen sortieren
sort_by_parent_name = Nach übergeordnetem Ordner sortieren
sort_by_full_name = Nach Vollnamen sortieren
sort_by_size = Nach Größe sortieren
sort_by_modification_date = Nach Änderungsdatum sortieren
sort_by_selection = Nach Auswahl sortieren
sort_reverse = Reihenfolge umkehren
sort_by_checked = Nach Checkstatus sortieren
selection_all = Alles auswählen
selection_deselect_all = Alles abwählen
