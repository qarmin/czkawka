...
other_apps_mykrut_desc = Einfacher und schneller Linux Dateimanager.
other_apps_dcmki_viewer_desc = Einfacher DICOM-Viewer.
other_apps_video_thumbnailer_desc = Wrapper um den Video-Thumbnail-Generator in Czkawka verwendet.
