...
rust_compared_image_hashes = مقایسه سیمباکس تصاویر { \$items_stats }
...
rust_rename_summary = تغییر نام { $-renamed } آیتم، نتوانسته تغییر نام داد { $-failed } آیتم، از مجموع { $-total } آیتم
...
rust_delete_confirmation_number_simple = { $	items	} کانتینت انتخاب شده‌اند.
