...
rust_rename_single_invalid_name = نام جدید نباید خالی باشد یا شامل جداکننده‌های مسیر (مانند `/` یا `\`) باشد.
rust_rename_single_target_exists = فایلی با این نام از قبل در این پوشه وجود دارد.
rust_rename_single_same_name = نام جدید، همان نام فعلی است.
rust_renamed_file = نام { $old_name } به { $new_name } تغییر یافت
...
rust_trash_confirmation = آیا مطمئن هستید که می‌خواهید موارد انتخاب شده را به سطل زباله منتقل کنید؟
rust_trash_confirmation_unsupported_volumes = توجه: همه قسمت‌ها از قابلیت انتقال به سطل زباله پشتیبانی نمی‌کنند. برای قسمت‌هایی که پشتیبانی نمی‌شوند، این عملیات همیشه با خطا مواجه خواهد شد.
rust_trash_confirmation_number_simple = { $items } آیتم‌های انتخاب شده.
rust_trash_confirmation_number_groups = { $items } مورد در { $groups } گروه انتخاب شده است.
rust_trash_confirmation_selected_all_in_group = همه آیتم‌ها در { $groups } گروه انتخاب شده است.
...
main_window_title = Krokiet (کروکت) - پاکنامه داده‌ها
...
motto = این برنامه برای استفاده کاملاً رایگان است و همیشه نیز همینطور خواهد بود. برای جزئیات بیشتر، به مجوز MIT/GPL مراجعه کنید.
unicorn = شاید شما اسب‌تک‌شاخ نبینید، اما اسب‌تک‌شاخ همیشه شما را می‌بیند.
repository = گارایو
instruction = دکمه دستورالعمل
donation = پیمانکار
translation = ترجمه:
other_apps = برنامه‌های دیگر
build_info_build = ساختن
build_info_runtime = زمان اجرا
build_info_refresh = به روز رسانی کنید
build_info_diagnostic_button = اطلاعات تشخیصی
build_info_diagnostic_title = اطلاعات تشخیصی
build_info_library_restart_hint = * فایل‌های بررسی‌شده کتابخانه (HEIF، LibRAW، AVIF) وضعیت را در زمان راه‌اندازی نشان می‌دهند. پس از نصب یا حذف افزونه‌ها، برنامه را مجدداً راه‌اندازی کنید.
build_info_test_file = فایل آزمایشی
other_apps_title = سایر برنامه‌های شرکت qarmin
other_apps_open_source_note = همه نرم‌افزارهای ذکر شده، رایگان و متن‌باز هستند.
other_apps_open_button = باز
other_apps_szyszka_desc = یک ابزار سریع و قدرتمند برای تغییر نام فایل ها.
other_apps_mykrut_desc = یک مدیر فایل لینوکس، ساده، سریع و با رویکرد خاص.
other_apps_dcmki_viewer_desc = یک نرم‌افزار مشاهده ساده تصاویر DICOM.
other_apps_video_thumbnailer_desc = یک لایه پوششی (wrapper) برای تولیدکننده تصاویر کوچک ویدیو که در Czkwka استفاده می‌شود.
other_apps_space_finder_desc = یافتن سریع و آسان بزرگترین فایل‌ها در سیستم شما.
other_apps_system_info_collector_desc = مصرف حافظه (RAM) و پردازنده (CPU) را از سیستم عامل جمع‌آوری کرده و آن را به صورت نمودار نمایش می‌دهد.
...
tool_music_duplicates = تکراری‌های موسیقی
...
sort_by_focus = مرتب‌سازی بر اساس موضوع اصلی
...
selection_invert_selection_in_group = معکوس کردن انتخاب در گروه
...
selection_all_except_biggest_size = همه موارد را انتخاب کنید، به جز بزرگترین سایز
selection_all_except_smallest_size = همه موارد را انتخاب کنید، به جز کوچکترین سایز
selection_all_except_biggest_resolution = همه موارد را انتخاب کنید، به جز رزولوشن با بزرگترین اندازه
selection_all_except_smallest_resolution = همه را انتخاب کن، به جز رزولوشن کمترین
selection_all_except_newest = انتخاب همه مواردی که نوزاد نیستند
selection_all_except_oldest = انتخاب همه غیر از قدیمی nhất
selection_all_except_longest_path = انتخاب همه موارد به جز طولانی‌ترین مسیر
selection_all_except_shortest_path = انتخاب همه چیز به جز کوتاه‌ترین مسیر
...
subsettings_images_ignore_same_resolution = تصاویری با همان رزولوشن را نادیده بگیرید
subsettings_images_max_difference = مaks تفاوت
subsettings_images_geometric_invariance = ناوردایی هندسی
...
option_search_mode_smallest = تازیست
option_music_method_tags = برچسب‌ها
option_music_method_fingerprint = اثر انگشت
option_check_method_hash = هش
option_check_method_size = اندازه
option_check_method_name = نام
option_check_method_size_and_name = حجم و نام
option_crop_detect_letterbox = جعبه نامه
option_crop_detect_motion = حرکت
option_crop_detect_none = هیچ
option_video_crop_type_black_bars = نوار مشکی
option_video_crop_type_static_content = محتوای ثابت
option_video_optimizer_mode_crop = کَندِن/برداشتن/چیدن
option_video_optimizer_mode_transcode = تبدیل فرمت کنید
option_noise_reduction_none = هیچ
option_noise_reduction_hqdn3d = hqdn3d (سریع)
subsettings_videos_max_difference = مaks تفاوت
subsettings_videos_ignore_same_size = ویدیوهایی با اندازه یکسان را نادیده بگیرید
subsettings_videos_ignore_same_resolution = ویدیوهایی که دارای همان رزولوشن هستند را نادیده بگیرید
subsettings_videos_audio_check_content = مقایسه بر اساس اثر انگشت صوتی
subsettings_videos_audio_preset = تنظیم سریع
subsettings_videos_audio_preset_custom = سفارشی
subsettings_videos_audio_preset_identical = ویدیوهای یکسان
subsettings_videos_audio_preset_clip = بخشی از ویدئوی طولانی‌تر را انتخاب و برش دهید
subsettings_videos_audio_preset_similar = محتوای مشابه
subsettings_videos_visual_preset = تنظیم از پیش تعریف شده سریع
subsettings_videos_visual_preset_custom = سفارشی
subsettings_videos_visual_preset_near_identical = تقریباً یکسان
subsettings_videos_visual_preset_similar = مشابه
subsettings_videos_visual_preset_movies = فیلم‌ها (پریدن طولانی)
subsettings_videos_duration_tolerance_pct = میزان تحمل در طول زمان [٪]
subsettings_videos_min_matching_windows = پنجره‌های با تطابق حداقل
subsettings_videos_subclip_min_match = حداقل تطابق برای زیربخش
subsettings_videos_audio_similarity_percent = شباهت [%]
subsettings_videos_audio_length_ratio = نسبت حداقل طول (کوتاه‌تر/بلندتر)
subsettings_videos_audio_min_duration_seconds = مدت زمان فایل [ثانیه]
subsettings_videos_audio_maximum_difference = حداکثر تفاوت در صدا
...
subsettings_empty_files_type = انواع فایل‌های اضافی که باید جستجو شوند
subsettings_empty_files_zero_byte_content = فایل‌هایی که با بایت‌های صفر پر شده‌اند
subsettings_empty_files_zero_byte_content_hint = همچنین، فایل‌هایی را پیدا کنید که خالی نباشند، اما کل محتوای آن‌ها از بایت‌های صفر (0x00) تشکیل شده باشد.
subsettings_empty_files_non_printable_content = فایل‌هایی که حاوی کاراکترهای غیرقابل چاپ هستند
subsettings_empty_files_non_printable_content_hint = همچنین، فایل‌هایی را پیدا کنید که خالی نباشند و فقط از کاراکترهای ASCII غیرقابل چاپ تشکیل شده باشند: null، فاصله، تب، CR، LF، VT، FF.
...
subsettings_broken_files_video_ffprobe = ویدیو (ffprobe)
subsettings_broken_files_video_ffprobe_info = بررسی سریع ویدیو با استفاده از ffprobe (تایید اعتبار هدر).
subsettings_broken_files_video_ffmpeg = ویدئو (ffmpeg)
subsettings_broken_files_video_ffmpeg_info = بررسی عمیق ویدیو با استفاده از ffmpeg (دیکدینگ کامل). این فرایند بسیار کند است و ممکن است حتی خطاهای جزئی را تشخیص دهد، حتی اگر فایل به درستی پخش شود.
subsettings_broken_files_font = فونت
subsettings_broken_files_markup = ساختاردهی (به فرمت JSON/XML/TOML)
...
settings_similar_images_show_image_preview = نمایش پیش‌نمایش تصویر
settings_similar_videos_preview_hint = پیش‌نمایش فقط زمانی قابل مشاهده است که گزینه "ایجاد تصاویر کوچک" فعال باشد، یا زمانی که یک تصویر کوچک از قبل تولید شده باشد.
...
settings_video_thumbnails_position = موقعیت تصویر کوچک در ویدئو (%)
...
settings_select_header_text = انتخاب تنظیمات پنجره بازشو
settings_select_group_size_text = اندازه
settings_select_group_date_text = تاریخ تغییر"http://www.example.com/"
settings_select_group_resolution_text = تصمیم‌گیری/نتیجه‌گیری
settings_select_group_path_text = مسیر
settings_select_label_one_smallest_text = کوچکترین
settings_select_label_one_biggest_text = یکی از بزرگترین
settings_select_label_except_smallest_text = به جز موارد بسیار کوچک
settings_select_label_except_biggest_text = به جز بزرگترین
settings_select_label_one_oldest_text = قدیمی‌ترین‌ها
settings_select_label_one_newest_text = جدیدترین
settings_select_label_except_oldest_text = به جز قدیمی‌ترین‌ها
settings_select_label_except_newest_text = به جز جدیدترین‌ها
settings_select_label_shortest_text = کوچکترین
settings_select_label_longest_text = طولانی‌ترین
settings_select_label_except_shortest_text = به جز موارد بسیار کوتاه
settings_select_label_except_longest_text = به جز موارد طولانی‌تر
...
settings_notification_feature_hint_text = فقط در صورتی که با قابلیت اعلان‌ها کامپایل شود، در دسترس است
settings_notification_focused_hint_text = ممکن است اعلان به صورت یک پنجره جداگانه نمایش داده نشود، زمانی که پنجره اصلی برنامه فعال باشد
...
popup_rename_single_title = تغییر نام فایل
popup_rename_single_same_name = نام جدید همان نام فعلی است.
popup_rename_single_target_exists = فایلی با این نام از قبل در این پوشه وجود دارد.
popup_error_title = خطا
...
popup_move_rename_on_conflict_checkbox = تغییر نام در صورت تداخل (به جای رد کردن)
...
subsettings_video_optimizer_noise_reduction = کاهش نویز
subsettings_video_optimizer_noise_reduction_strength = قدرت NR
subsettings_video_optimizer_use_custom_command = از دستور FFmpeg سفارشی استفاده کنید
subsettings_video_optimizer_custom_command_hint = Command with { "{PATH}" } for input file. Output path is appended automatically.
subsettings_video_optimizer_hardware_encoder = رمزگذار سخت‌افزاری
subsettings_video_optimizer_generate_template = یک قالب ایجاد کنید
...
subsettings_temporary_files_extensions_text = اضافه‌ها:
subsettings_temporary_files_extensions_hint_text = لیستی از پسوندهای/پسوندها که به صورت جداشده با کاما مشخص شده‌اند و به عنوان موقت در نظر گرفته می‌شوند (مثلاً .tmp، .bak، ~). گزینه "بازنشانی" تنظیمات پیش‌فرض را به حالت اولیه برمی‌گرداند.
...
optimize_crf_hint = مقدار کمتر = کیفیت بهتر. مقدار 0 تقریباً بدون افت کیفیت است، در حالی که مقدار 51 بدترین حالت است. پیشنهاد می‌شود از مقادیر 18 تا 28 استفاده کنید.
optimize_noise_reduction_hint = کاهش نویز ممکن است زمان کدگذاری را به طور قابل توجهی افزایش دهد.
optimize_noise_reduction_strength_hint = 1 = کمترین میزان، 10 = بیشترین میزان کاهش نویز.
...
popup_custom_select_title_text = انتخاب/حذف انتخابی سفارشی
popup_custom_select_button_text = انتخاب کنید
popup_custom_unselect_button_text = عدم انتخاب
popup_custom_column_name_header_text = ستون
popup_custom_filter_value_header_text = مقدار فیلتر (حروف جایگزین / عبارت منظم)
popup_custom_case_sensitive_text = حساس به حروف تکیه‌گاه
popup_custom_leave_one_in_group_text = تمام آیتم‌ها را انتخاب کنید، با این استثنا که در هر گروه، فقط یک آیتم را انتخاب نکنید
popup_custom_hint_str_text = ستون‌های متنی: کاراکترهای جایگزین، *name*، /home/*، *.rs
...
popup_custom_save_restore_text = ذخیره و بازیابی اطلاعات فیلتر
compare_button_text = مقایسه
...
compare_split_text = تقسیم کنید
compare_overlay_text = پوشش
compare_loading_title_text = لطفاً منتظر بمانید...
compare_cancel_text = لغو
...
compare_info_resolution_text = تصمیم‌گیری/نتیجه‌گیری
compare_info_modification_date_text = تاریخ آخرین تغییرات
compare_loading_images_text = در حال بارگذاری تصاویر...
compare_cancelling_text = لغو در حال انجام... لطفا منتظر بمانید.
context_menu_open_item_text = آیتم باز
context_menu_open_parent_text = باز کردن پوشه والد
context_menu_remove_from_results_text = از نتایج حذف کن
context_menu_remove_all_from_folder_text = حذف همه موارد از پوشه
context_menu_remove_all_from_folder_recursive_text = حذف همه فایل‌ها از پوشه (به صورت بازگشتی)
context_menu_select_all_from_folder_text = انتخاب همه فایل‌ها از پوشه
context_menu_select_all_from_folder_recursive_text = انتخاب همه موارد از پوشه (به صورت بازگشتی)
context_menu_exclude_parent_folder_text = پوشه والد را حذف نکنید
context_menu_exclude_item_text = حذف مورد
context_menu_copy_file_name_text = کپی کردن نام فایل
context_menu_copy_parent_folder_path_text = کپی کردن پوشه والد
context_menu_copy_full_path_text = کپی کردن مسیر کامل
context_menu_rename_text = تغییر نام
