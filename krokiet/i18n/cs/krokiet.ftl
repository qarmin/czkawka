...
rust_checked_images = Zkontrolováno { $items_stats } obrázků ({ $size_stats })
...
settings_application_scale_hint_text = Ruční měřítko (např. 1.0 = 100 %)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Generujte mřížku miniatur namísto jediného obrázku (může trvat déle)
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Generovat dlaždicovou galerii namísto jedné obrázku
settings_similar_videos_clear_unused_thumbnails = Smažte nepoužívané videové náhledy starší než 7 dní při spuštění aplikace
...
subsettings_video_optimizer_image_threshold = Obnovovací práh obrázku
...
optimize_text = Optimalizovat obrázky
optimize_confirmation_text = Jste si jistí, že chcete optimalizovat vybrané položky?
