...
rust_compared_image_hashes = Porovnat hash obrázků { $items_stats }
...
rust_found_duplicate_files = Nalezeno { $items_found } duplicitních souborů
...
rust_delete_summary = Smazáno { $deleted } položek, nepodařilo se odstranit { $failed } položky, ze všech { $total } položek
rust_rename_summary = Přejmenováno { $renamed } položek, nepodařilo se přejmenovat { $failed } položky, ze všech { $total } položek
rust_move_summary = Přesunuto { $moved } položek, se nepodařilo přesunout { $failed } položky, ze všech { $total } položek
...
rust_no_files_deleted = Nevybrány žádné soubory/složky k odstranění
rust_no_files_renamed = Nevybrány žádné soubory/složky pro přejmenování
rust_no_files_moved = Nevybrány žádné soubory/složky k přesunutí
rust_delete_confirmation = Jste si jisti, že chcete vybrané položky?
rust_delete_confirmation_number_simple = { $items } položek je vybráno.
rust_delete_confirmation_number_groups = { $items } položek v { $groups } skupinách je vybráno.
rust_delete_confirmation_selected_all_in_group = Ve skupinách { $groups } jsou vybrány všechny položky.
...
sort_by_parent_name = Seřadit podle nadřazené složky
...
sort_by_checked = Seřadit podle stavu
