...
rust_cannot_load_preset = No se puede cargar el preset { $preset_idx }, razón: { $reason }
rust_error_moving_to_trash = Error al mover a la papelera: { $error }
rust_error_removing_file = Error al eliminar el archivo: { $error }
rust_delete_summary = Eliminados artículos { $deleted } no se han podido eliminar elementos { $failed }
rust_error_creating_folder = Error al crear la carpeta: { $error }
...
rust_hashed_images = Hash de imagen { $items_stats } ({ $size_stats })
rust_compared_image_hashes = Hash de imagen comparado { $items_stats }
rust_hashed_videos = Hash de vídeo { $items_stats }
...
rust_found_duplicate_files = Se encontraron archivos duplicados similares { $items_found }
...
manual_add_button = Añadir manual
...
sort_by_parent_name = Ordenar por nombre padre
...
sort_reverse = Clasificación inversa
...
subsettings_images_ignore_same_size = Ignorar el mismo tamaño
...
subsettings_videos_ignore_same_size = Ignorar el mismo tamaño
...
subsettings_music_compare_fingerprints_only_with_similar_titles = Compara solo con títulos similares
...
delete_confirmation = ¿Está seguro que desea eliminar los elementos seleccionados?
