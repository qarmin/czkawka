...
rust_no_similarity_method_selected = No se pueden encontrar archivos de música similares sin un método de similitud seleccionado.
...
settings_similar_videos_image_preview = Vista previa de imagen
...
popup_rename_message = Esto renombrará las extensiones de los archivos seleccionados a las más apropiadas
...
subsettings_videos_thumbnail_percentage = Posición de miniatura en el video (%)
...
rust_checked_images = Revisado { $items_stats } imágenes ({ $size_stats })
...
settings_application_scale_hint_text = Escala de aplicación manual (ej., 1.0 = 100%)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Generar una cuadrícula de miniaturas en lugar de una sola imagen (puede tardar más)
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Generar cuadrícula de miniaturas en lugar de una sola imagen
settings_similar_videos_clear_unused_thumbnails = Eliminar miniaturas de video no utilizadas que tengan más de 7 días al inicio de la aplicación
...
subsettings_video_optimizer_image_threshold = Umbral de imagen
...
optimize_text = Optimizar imágenes
optimize_confirmation_text = ¿Está usted seguro de que desea optimizar los elementos seleccionados?
