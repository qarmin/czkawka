...
rust_rename_single_invalid_name = El nombre nuevo no debe estar vacío o contener separadores de rutas.
rust_rename_single_target_exists = Ya existe un archivo con ese nombre en esta carpeta.
rust_rename_single_same_name = Nuevo nombre es el mismo que el actual.
rust_renamed_file = Renombrado { $old_name } a { $new_name }
...
rust_trash_confirmation = ¿Está seguro que desea mover los elementos seleccionados a la papelera?
rust_trash_confirmation_unsupported_volumes = Nota: no todos los volúmenes soportan mover a la papelera. Para volúmenes no soportados, esta operación siempre fallará.
rust_trash_confirmation_number_simple = { $items } elementos seleccionados.
rust_trash_confirmation_number_groups = { $items } elementos seleccionados en grupos { $groups }.
rust_trash_confirmation_selected_all_in_group = Todos los elementos seleccionados en grupos { $groups }.
...
main_window_title = Krokiet (Croqueta) - Limpiador de datos
file_dialog_open = Cerrar la ventana de diálogo para continuar
...
motto = Este programa es de uso gratuito y siempre lo será. Consulte la licencia MIT/GPL para obtener más detalles.
...
build_info_runtime = Tiempo de ejecución
build_info_refresh = Actualizar
build_info_diagnostic_button = Información de diagnóstico
build_info_diagnostic_title = Información de diagnóstico
build_info_library_restart_hint = * Las pruebas de la biblioteca (HEIF, LibRAW, AVIF) reflejan el estado al inicio; reinicie la aplicación después de instalar o desinstalar complementos.
build_info_test_file = Archivo de prueba
other_apps_title = Otras aplicaciones por qarmin
other_apps_open_source_note = Todas las aplicaciones listadas son gratuitas y de código abierto.
other_apps_open_button = Abrir
other_apps_szyszka_desc = Rápido y poderoso renombrador de archivos.
other_apps_mykrut_desc = Administrador de archivos de Linux simple y rápido y con opinión.
other_apps_dcmki_viewer_desc = Visor DICOM simple.
other_apps_video_thumbnailer_desc = Envoltura alrededor del generador de miniaturas de vídeo utilizado en el kawka.
other_apps_space_finder_desc = Buscador simple de los archivos más grandes de su sistema.
other_apps_system_info_collector_desc = Recoge el uso de RAM/CPU del sistema operativo y lo muestra como gráficos.
...
selection_all_except_biggest_size = Seleccionar todo excepto el tamaño mayor
selection_all_except_smallest_size = Seleccionar todo excepto el tamaño más pequeño
selection_all_except_biggest_resolution = Seleccionar todo excepto mayor resolución
selection_all_except_smallest_resolution = Seleccionar todo excepto la resolución más pequeña
selection_all_except_newest = Seleccionar todo excepto el más reciente
selection_all_except_oldest = Seleccionar todo excepto más antiguo
...
selection_custom_select_unselect = Seleccionar/Deseleccionar Personalizado
...
subsettings_images_geometric_invariance = invariancia geométrica
...
option_music_method_fingerprint = Huella dactilar
...
option_crop_detect_none = Ninguna
option_video_crop_type_black_bars = Barra negra
...
option_noise_reduction_none = Ninguna
...
subsettings_videos_audio_check_content = Comparar por huella digital de audio
subsettings_videos_audio_preset = Ajuste rápido
subsettings_videos_audio_preset_custom = Personalizado
subsettings_videos_audio_preset_identical = Vídeos idénticos
subsettings_videos_audio_preset_clip = Clip en vídeo más largo
subsettings_videos_audio_preset_similar = Contenido similar
subsettings_videos_visual_preset = Ajuste rápido
subsettings_videos_visual_preset_custom = Personalizado
subsettings_videos_visual_preset_near_identical = Cercano idéntico
subsettings_videos_visual_preset_similar = Similar
subsettings_videos_visual_preset_movies = Películas (salto largo)
subsettings_videos_duration_tolerance_pct = Tolerancia de duración [%]
subsettings_videos_min_matching_windows = Ventanas mínimas coincidentes
subsettings_videos_subclip_min_match = Partida mínima del subclip
subsettings_videos_audio_similarity_percent = Similaridad [%]
subsettings_videos_audio_length_ratio = Ratio de longitud mínima (corto/largo)
subsettings_videos_audio_min_duration_seconds = Duración mínima del archivo [s]
subsettings_videos_audio_maximum_difference = Diferencia máxima de audio
...
subsettings_empty_files_type = Tipos de archivo adicionales a encontrar
subsettings_empty_files_zero_byte_content = Archivos rellenados con bytes nulos
subsettings_empty_files_zero_byte_content_hint = También puede encontrar archivos no vacíos cuyo contenido entero consiste en bytes null (0x00).
subsettings_empty_files_non_printable_content = Archivos rellenados con caracteres no imprimibles
subsettings_empty_files_non_printable_content_hint = También encuentre archivos no vacíos que consten sólo de caracteres ASCII no imprimibles: null, espacio, tab, CR, LF, VT, FF.
...
subsettings_broken_files_video_ffprobe_info = Comprobación rápida de vídeo usando ffprobe (validación de encabezado).
subsettings_broken_files_video_ffmpeg = Video (ffmpeg)
subsettings_broken_files_video_ffmpeg_info = Comprobación de vídeo profunda usando ffmpeg (decodificación completa). Muy lenta y puede detectar errores pedánticos incluso si el archivo se reproduce correctamente.
...
settings_similar_videos_preview_hint = La vista previa sólo es visible cuando "Generar miniaturas" está activada, o cuando ya se ha generado una miniatura.
...
settings_select_header_text = Seleccionar opciones emergentes
...
settings_select_label_except_smallest_text = Excepto más pequeño
settings_select_label_except_biggest_text = Excepto más grande
settings_select_label_one_oldest_text = Uno más antiguo
settings_select_label_one_newest_text = Un nuevo
settings_select_label_except_oldest_text = Excepto más antiguo
settings_select_label_except_newest_text = Excepto más reciente
settings_select_label_shortest_text = Más corto
settings_select_label_longest_text = Más largo
settings_select_label_except_shortest_text = Excepto más corto
settings_select_label_except_longest_text = Excepto más largo
...
settings_show_notification_on_scan_completion_text = Mostrar notificación cuando se complete el escaneo
settings_notification_feature_hint_text = Disponible sólo cuando se compile con la función de notificaciones
settings_notification_focused_hint_text = La notificación puede no aparecer como ventana emergente cuando la ventana de la aplicación está enfocada
...
popup_rename_single_title = Renombrar archivo
popup_rename_single_same_name = Nuevo nombre es el mismo que el actual.
popup_rename_single_target_exists = Ya existe un archivo con ese nombre en esta carpeta.
...
popup_move_rename_on_conflict_checkbox = Renombrar en conflicto (en lugar de saltar)
...
trash = Mover elementos a la papelera
...
subsettings_videos_window_count = Contador de ventana
...
subsettings_video_optimizer_noise_reduction = Reducción del ruido
subsettings_video_optimizer_noise_reduction_strength = Intensidad NR
...
subsettings_temporary_files_extensions_hint_text = Lista separada por comas de extensiones/sufijos tratados como temporales (por ejemplo, .tmp,.bak,~). Restablecer restaura los valores predeterminados predeterminados.
...
optimize_crf_hint = Valor más bajo = mejor calidad. 0 es casi sin pérdida, 51 es peor. Recomendado: 18-28.
optimize_noise_reduction_hint = La reducción del ruido puede aumentar significativamente el tiempo de codificación.
optimize_noise_reduction_strength_hint = 1 = mínimo, 10 = reducción máxima de ruido.
...
popup_custom_unselect_button_text = Deseleccionar
popup_custom_column_name_header_text = Columna
popup_custom_filter_value_header_text = Valor del filtro (comodín / regex)
popup_custom_case_sensitive_text = Distingue mayúsculas y minúsculas
popup_custom_leave_one_in_group_text = Seleccionar todos los elementos excepto uno, en cada grupo
popup_custom_hint_str_text = Columnas de texto: comodín *name* /home/* *.rs
popup_custom_hint_int_text = Tamaño [KB] / columnas numéricas: >= 2048 < 512 = 0 (operadores: >= <= > < =)
popup_custom_hint_date_text = Columnas de fecha: DD-MM-AAAA o AAA-MM-DD, hora opcional HH:MM:SS p.ej. >= 2020-01-01 o < 31-12-2022 23:59:59
popup_custom_save_restore_text = Guardar y restaurar datos de filtro
...
compare_swap_text = Intercambiar
compare_info_text = Información
compare_diff_text = Diferencia
compare_split_text = Dividir
compare_overlay_text = Superposición
compare_loading_title_text = Por favor espere...
compare_cancel_text = Cancelar
compare_resolution_mismatch_text = Diferentes resoluciones - los resultados de diferencias pueden ser inexactos
compare_computing_diff_text = Calculando difi...
compare_info_file_name_text = Nombre de archivo
...
context_menu_open_item_text = Abrir elemento
...
context_menu_remove_all_from_folder_recursive_text = Eliminar todo de la carpeta (recursiva)
context_menu_select_all_from_folder_text = Seleccionar todo de la carpeta
context_menu_select_all_from_folder_recursive_text = Seleccionar todo de la carpeta (recursiva)
context_menu_exclude_parent_folder_text = Excluir carpeta padre
context_menu_exclude_item_text = Excluir objeto
context_menu_copy_file_name_text = Copiar nombre de archivo
context_menu_copy_parent_folder_path_text = Copiar carpeta padre
context_menu_copy_full_path_text = Copiar ruta completa
context_menu_rename_text = Renombrar
