...
rust_compared_image_hashes = Jämfört { $items_stats } bildhashar
...
rust_found_duplicate_files = Hittade { $items_found } duplicerade filer
...
rust_delete_summary = Borttagna { $deleted } objekt, misslyckades med att ta bort { $failed } objekt, från alla { $total } objekt
rust_rename_summary = Döp om { $renamed } objekt, kunde inte byta namn på { $failed } objekt, från alla { $total } objekt
rust_move_summary = Flyttade { $moved } objekt, kunde inte flytta { $failed } objekt, från alla { $total } objekt
...
rust_no_files_deleted = Inte valt några filer/mappar att ta bort
rust_no_files_renamed = Inte valt några filer/mappar att byta namn på
rust_no_files_moved = Inte valt några filer/mappar att flytta
rust_delete_confirmation = Är du säker på att du vill ha de markerade objekten?
rust_delete_confirmation_number_simple = { $items } objekt är markerade.
rust_delete_confirmation_number_groups = { $items } objekt i { $groups } grupper är markerade.
rust_delete_confirmation_selected_all_in_group = I { $groups } grupper finns alla objekt valda.
...
sort_by_parent_name = Sortera efter överordnad mapp
...
sort_by_checked = Sortera efter check-status
