...
rust_found_broken_files = Found { $items_found } broken files, which took { $size } in { $time }
rust_found_bad_extensions = Found { $items_found } files with bad extensions in { $time }
rust_found_duplicate_files = Found { $items_found } duplicate files in { $groups } groups, which took { $size } in { $time }
