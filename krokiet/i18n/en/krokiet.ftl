...
rust_found_similar_images = Found { $items_found } similar image files in { $time }
rust_found_similar_videos = Found { $items_found } similar video files in { $time }
rust_no_similarity_method_selected = Cannot find similar music files without any similarity method selected.
rust_found_similar_music_files = Found { $items_found } similar music files in { $time }
...
rust_found_broken_files = Found { $items_found } broken files in { $time }
rust_found_bad_extensions = Found { $items_found } files with bad extensions in { $time }
rust_found_duplicate_files = Found { $items_found } duplicate files in { $time }
rust_found_big_files = Found { $items_found } big files in { $time }
