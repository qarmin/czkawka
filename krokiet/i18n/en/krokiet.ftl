...
subsettings_videos_audio_check_content = Compare by audio fingerprint (no ffmpeg needed)
subsettings_videos_audio_max_duration_diff_ratio = Max duration difference ratio (0–1)
subsettings_videos_audio_minimum_segment_duration = Min matching segment [s]
