...
subsettings_bad_names_issues = Issues to check
subsettings_bad_names_uppercase_extension = Downcase extension
subsettings_bad_names_emoji_used = Remove emoji
subsettings_bad_names_space_at_start_end = Remove space at start/end
subsettings_bad_names_non_ascii = Replace/remove non-ASCII chars
subsettings_bad_names_restricted_charset = Limited chars (besides 0-9a-zA-Z)
subsettings_bad_names_remove_duplicated = Remove duplicated non-alphanumeric chars
