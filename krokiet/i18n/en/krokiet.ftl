...
popup_clean_cache_files_processed_text = Files processed:
popup_clean_cache_entries_removed_text = Outdated entries removed:
popup_clean_cache_bytes_saved_text = Space saved:
popup_clean_cache_time_elapsed_text = Time elapsed:
popup_clean_cache_errors_text = Files with errors:
