...
rust_all_dirs_referenced = Cannot start scan when all included directories are set as referenced folders, you need to disable reference checkbox next to input path.
...
subsettings_video_optimizer_black_pixel_threshold_hint = Maximum RGB value for each pixel channel to be considered black (0-255). Default: 20
subsettings_video_optimizer_black_bar_min_percentage = Black Bar Min Percentage
subsettings_video_optimizer_black_bar_min_percentage_hint = Minimum percentage of black pixels in a row/column to be considered a black bar (0.0-1.0). Default: 0.9
subsettings_video_optimizer_max_samples = Max Samples
subsettings_video_optimizer_max_samples_hint = Maximum number of frames to analyze per video. Default: 60
subsettings_video_optimizer_min_crop_size = Min Crop Size
subsettings_video_optimizer_min_crop_size_hint = Minimum pixels to crop on any side. Smaller crops are ignored. Default: 5
