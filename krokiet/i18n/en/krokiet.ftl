...
rust_found_iv_optimizer = Found { $items_found } files to optimize in { $time }
...
tool_iv_optimizer = IV Optimizer
tool_exif_finder = Exif Remover
...
subsettings_iv_optimizer_mode = Mode
subsettings_iv_optimizer_video_codec = Video codec
subsettings_iv_optimizer_excluded_codecs = Excluded codecs
subsettings_iv_optimizer_video_quality = Video quality (CRF)
subsettings_iv_optimizer_image_threshold = Image threshold
subsettings_reset = Reset
subsettings_exif_ignored_tags_text = Ignored tags (comma-separated):
subsettings_exif_ignored_tags_hint_text = Tags to exclude from scanning (e.g. GPS, Thumbnail, MakerNote)
