...
subsettings_empty_files_whitespace_content = Files filled with whitespace characters
subsettings_empty_files_whitespace_content_hint = Also find non-empty files consisting only of whitespace/non-printing ASCII: null, space, tab, CR, LF, VT, FF.
