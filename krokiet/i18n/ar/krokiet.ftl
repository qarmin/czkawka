...
build_info_library_restart_hint = * تتضمن مكتبات التحقق (HEIF، LibRAW، AVIF) معلومات حول الحالة في وقت بدء التشغيل - أعد تشغيل التطبيق بعد تثبيت أو إزالة المكونات الإضافية.
...
other_apps_szyszka_desc = إعادة تشغيل الملف بسرعة وقوة.
other_apps_mykrut_desc = مدير ملفات لينكس سريع و مرؤوس.
...
other_apps_system_info_collector_desc = يجمع استخدام RAM/CUPU من نظام التشغيل ويعرضها كرسوم بيانية.
