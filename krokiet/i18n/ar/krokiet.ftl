...
rust_compared_image_hashes = مقارنة تجزئة الصور { $items_stats }
...
rust_found_duplicate_files = تم العثور على { $items_found } ملفات مكررة
...
rust_delete_summary = حذف { $deleted } عناصر, فشل في إزالة { $failed } عناصر, من جميع { $total } عناصر
rust_rename_summary = إعادة تسمية العناصر { $renamed } ، فشل في إعادة تسمية العناصر { $failed } ، من جميع العناصر { $total }
rust_move_summary = نقل { $moved } عناصر, فشل في نقل { $failed } عناصر, من جميع { $total } عناصر
...
rust_no_files_deleted = لم يتم تحديد أي ملفات/مجلدات للحذف
rust_no_files_renamed = لم يتم تحديد أي ملفات/مجلدات لإعادة التسمية
rust_no_files_moved = لم يتم تحديد أي ملفات/مجلدات للنقل
rust_delete_confirmation = هل أنت متأكد من أنك تريد العناصر المحددة؟
...
rust_delete_confirmation_selected_all_in_group = في مجموعات { $groups } ، هناك جميع العناصر المحددة.
...
sort_by_parent_name = الترتيب حسب المجلد الأصلي
...
sort_by_checked = الترتيب حسب حالة التحقق
