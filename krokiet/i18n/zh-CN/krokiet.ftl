...
rust_loading_tags_cache = 正在加载标签缓存
...
rust_loading_hash_cache = 正在加载哈希缓存
rust_saving_hash_cache = 正在保存哈希缓存
...
rust_checked_content = 已检查的 { $items_stats } ({ $size_stats })
