...
rust_found_empty_folders = Trovate { $items_found } cartelle vuote
rust_found_empty_files = Trovati { $items_found } file vuoti
...
rust_found_invalid_symlinks = Trovati { $items_found } colegamenti simbolici invalidi
rust_found_temporary_files = Trovati { $items_found } file temporanei
rust_no_file_type_selected = Impossibile trovare file corrotti senza alcun tipo di file selezionato.
rust_found_broken_files = Trovati { $items_found } file corrotti
...
rust_found_big_files = Trovati { $items_found } grandi file
...
rust_delete_summary = Eliminato elementi { $deleted } , non è stato possibile rimuovere gli elementi { $failed } da tutti gli elementi { $total }
rust_rename_summary = Rinominato { $renamed } elementi, non è stato possibile rinominare gli elementi { $failed } , da tutti gli elementi { $total }
rust_move_summary = Spostato elementi { $moved } , non è stato possibile spostare elementi { $failed } da tutti gli elementi { $total }
...
rust_no_files_deleted = Non è stato selezionato alcun file/cartella da eliminare
rust_no_files_renamed = Non è stato selezionato alcun file/cartella da rinominare
rust_no_files_moved = Non è stato selezionato alcun file/cartella da spostare
rust_delete_confirmation = Sei sicuro di voler gli elementi selezionati?
rust_delete_confirmation_number_simple = { $items } elementi è selezionato.
rust_delete_confirmation_number_groups = { $items } elementi in { $groups } gruppi sono selezionati.
rust_delete_confirmation_selected_all_in_group = In gruppi { $groups } , ci sono tutti gli elementi selezionati.
...
sort_by_parent_name = Ordina per cartella superiore
...
sort_by_checked = Ordina per stato di controllo
