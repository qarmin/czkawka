...
rust_cannot_load_preset = Αδυναμία φόρτωσης προκαθορισμένου { $preset_idx }, λόγος: { $reason }
...
rust_delete_summary = Διαγράφηκε { $deleted } στοιχεία, απέτυχε να αφαιρέσει { $failed } στοιχεία
rust_error_creating_folder = Σφάλμα κατά τη δημιουργία φακέλου: { $error }
...
rust_hashed_videos = Κατακερματισμένο από βίντεο { $items_stats }
...
rust_found_duplicate_files = Βρέθηκαν { $items_found } παρόμοια διπλότυπα αρχεία
...
manual_add_button = Χειροκίνητη Προσθήκη
...
sort_by_parent_name = Ταξινόμηση κατά γονικό όνομα
...
sort_reverse = Αντίστροφη ταξινόμηση
...
subsettings_images_ignore_same_size = Αγνόηση ίδιου μεγέθους
...
subsettings_videos_ignore_same_size = Αγνόηση ίδιου μεγέθους
...
subsettings_music_compare_fingerprints_only_with_similar_titles = Σύγκριση μόνο με παρόμοιους τίτλους
...
delete_confirmation = Είστε βέβαιοι ότι θέλετε να διαγράψετε τα επιλεγμένα αντικείμενα?
