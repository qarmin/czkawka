...
rust_error_moving_to_trash = Σφάλμα κατά τη μετακίνηση στον κάδο απορριμμάτων: { $error }
rust_error_removing_file = Σφάλμα κατά την αφαίρεση του αρχείου: { $error }
...
rust_failed_to_rename_file = Αποτυχία μετονομασίας αρχείου { $old_path } σε { $new_path } με σφάλμα { $error }
...
rust_found_empty_folders = Βρέθηκαν { $items_found } άδειοι φάκελοι
rust_found_empty_files = Βρέθηκαν { $items_found } άδεια αρχεία
rust_found_similar_images = Βρέθηκαν { $items_found } παρόμοια αρχεία εικόνας
rust_found_similar_videos = Βρέθηκαν { $items_found } παρόμοια αρχεία βίντεο
rust_no_similarity_method_selected = Δεν είναι δυνατή η εύρεση παρόμοιων αρχείων μουσικής χωρίς επιλεγμένη μέθοδο ομοιότητας.
rust_found_similar_music_files = Βρέθηκαν { $items_found } παρόμοια αρχεία μουσικής
rust_found_invalid_symlinks = Βρέθηκαν { $items_found } μη έγκυρες συμβολικές συνδέσεις
rust_found_temporary_files = Βρέθηκαν { $items_found } προσωρινά αρχεία
rust_no_file_type_selected = Αδυναμία εύρεσης κατεστραμμένων αρχείων χωρίς επιλεγμένο τύπο αρχείου.
rust_found_broken_files = Βρέθηκαν { $items_found } κατεστραμμένα αρχεία
rust_found_bad_extensions = Βρέθηκαν { $items_found } αρχεία με κακές επεκτάσεις
rust_found_duplicate_files = Βρέθηκαν { $items_found } διπλότυπα αρχεία
rust_found_big_files = Βρέθηκαν { $items_found } μεγάλα αρχεία
...
rust_delete_summary = Διαγράφηκε { $deleted } αντικείμενα, απέτυχε να αφαιρέσει { $failed } αντικείμενα, από όλα τα { $total } στοιχεία
rust_rename_summary = Μετονομασία { $renamed } αντικειμένων, απέτυχε να μετονομάσει { $failed } αντικείμενα, από όλα τα { $total } στοιχεία
rust_move_summary = Μετακινήθηκε { $moved } αντικείμενα, απέτυχε να μετακινήσει { $failed } αντικείμενα, από όλα τα { $total } στοιχεία
...
rust_no_files_deleted = Δεν έχουν επιλεγεί κανένα αρχείο/φάκελοι για διαγραφή
rust_no_files_renamed = Δεν έχουν επιλεγεί κανένα αρχείο/φάκελοι για μετονομασία
rust_no_files_moved = Δεν έχουν επιλεγεί κανένα αρχείο/φάκελοι για μετακίνηση
rust_delete_confirmation = Είστε βέβαιοι ότι θέλετε τα επιλεγμένα αντικείμενα?
rust_delete_confirmation_number_simple = { $items } είναι επιλεγμένα αντικείμενα.
rust_delete_confirmation_number_groups = { $items } items in { $groups } groups are selected.
rust_delete_confirmation_selected_all_in_group = Σε ομάδες { $groups } υπάρχουν όλα τα επιλεγμένα στοιχεία.
...
are_you_want_to_continue = Θέλετε να συνεχίσετε?
...
motto = Αυτό το πρόγραμμα είναι δωρεάν και πάντα θα είναι.\nΔείτε το The MIT/GPL License για λεπτομέρειες.
unicorn = Μπορεί να μην κοιτάξετε μονόκερο, αλλά μονόκερος σας κοιτάζει πάντα.
...
sort_by_item_name = Ταξινόμηση κατά όνομα στοιχείου
sort_by_parent_name = Ταξινόμηση κατά γονικό φάκελο
sort_by_full_name = Ταξινόμηση κατά πλήρες όνομα
sort_by_size = Ταξινόμηση κατά μέγεθος
sort_by_modification_date = Ταξινόμηση κατά ημερομηνία τροποποίησης
sort_by_selection = Ταξινόμηση κατά επιλογή
sort_reverse = Αντίστροφη σειρά
sort_by_checked = Ταξινόμηση κατά κατάσταση ελέγχου
...
popup_rename_message = Αυτό θα μετονομάσει τις επεκτάσεις των επιλεγμένων αρχείων σε πιο σωστή
