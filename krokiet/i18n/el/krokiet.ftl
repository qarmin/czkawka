...
build_info_library_restart_hint = * Οι έλεγχοι της βιβλιοθήκης (HEIF, LibRAW, AVIF) αντικατοπτρίζουν την κατάσταση κατά την εκκίνηση - επανεκκινήστε την εφαρμογή μετά την εγκατάσταση ή την αφαίρεση πρόσθετων λειτουργιών.
...
other_apps_szyszka_desc = Γρήγορη και ισχυρή μετονομασία αρχείων.
other_apps_mykrut_desc = Απλή γρήγορη και γνώμη διαχειριστή αρχείων Linux.
...
other_apps_space_finder_desc = Απλός εντοπισμός των μεγαλύτερων αρχείων στο σύστημά σας.
