...
rust_checked_images = { $items_stats } images vérifiées ({ $size_stats })
...
settings_application_scale_hint_text = Échelle manuelle de l'application (par exemple : 1.0 = 100%)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Générer une grille de vignettes au lieu d'une seule image (peut prendre plus longtemps)
...
settings_similar_videos_clear_unused_thumbnails = Supprimer les vignettes vidéo inutilisées de plus de 7 jours au démarrage de l'application
