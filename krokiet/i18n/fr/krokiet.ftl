...
rust_compared_image_hashes = Hachages d'images { $items_stats } comparés
...
rust_found_duplicate_files = Fichiers dupliqués { $items_found } trouvés
...
rust_delete_summary = Les éléments { $deleted } supprimés, impossible de supprimer les éléments { $failed } de tous les éléments { $total }
rust_rename_summary = Les éléments { $renamed } ont été renommés, impossible de renommer les éléments { $failed } , de tous les éléments { $total }
rust_move_summary = Les éléments { $moved } déplacés, impossible de déplacer les éléments { $failed } , de tous les éléments { $total }
...
rust_no_files_deleted = Aucun fichier/dossier à supprimer n'est sélectionné
rust_no_files_renamed = Aucun fichier/dossier à renommer n'est sélectionné
rust_no_files_moved = Aucun fichier/dossier à déplacer n'a été sélectionné
rust_delete_confirmation = Êtes-vous sûr de vouloir les éléments sélectionnés ?
rust_delete_confirmation_number_simple = Les éléments { $items } sont sélectionnés.
rust_delete_confirmation_number_groups = { $items } éléments dans les groupes { $groups } sont sélectionnés.
rust_delete_confirmation_selected_all_in_group = Dans les groupes { $groups } , il y a tous les éléments sélectionnés.
...
sort_by_parent_name = Trier par dossier parent
...
sort_by_checked = Trier par état de vérification
