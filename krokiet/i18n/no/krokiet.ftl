...
rust_compared_image_hashes = Sammenlignet { $items_stats } bilde hashes
...
rust_found_duplicate_files = Fant { $items_found } dupliserte filer
...
rust_delete_summary = Slettet { $deleted } elementer, kunne ikke fjerne { $failed } elementer, fra alle { $total } artikler
rust_rename_summary = Endret navn på { $renamed } elementer, mislyktes å endre navn på { $failed } elementer, fra alle { $total } elementer
rust_move_summary = Flyttet { $moved } elementer, feilet med å flytte { $failed } elementer, fra alle { $total } elementer
...
rust_no_files_deleted = Ikke valgt noen filer/mapper som skal slettes
rust_no_files_renamed = Ikke valgt noen filer/mapper å gi nytt navn
rust_no_files_moved = Ikke valgt noen filer/mapper å flytte
rust_delete_confirmation = Er du sikker på at du vil de valgte produktene?
rust_delete_confirmation_number_simple = { $items } elementer er valgt.
rust_delete_confirmation_number_groups = { $items } elementer i { $groups } grupper er valgt.
rust_delete_confirmation_selected_all_in_group = I { $groups } grupper er alle elementene valgt.
...
sort_by_parent_name = Sorter etter overordnet mappe
...
sort_by_checked = Sorter etter kontrollstatus
