...
other_apps_szyszka_desc = Rask og kraftig filomdømme.
other_apps_mykrut_desc = Enkel rask og opinionert Linux fil manager.
other_apps_dcmki_viewer_desc = Enkel DICOM seer.
other_apps_video_thumbnailer_desc = Wrapper around the video thumbnail generator used i Czkawka.
other_apps_space_finder_desc = En enkel finner av de største filene på systemet ditt.
