...
motto = Ця програма є безкоштовною у використанні і завжди буде такою. Детальніше про ліцензію MIT/GPL дивіться нижче.
...
build_info_build = Будувати
build_info_runtime = Час виконання
build_info_refresh = Оновити
build_info_diagnostic_button = Інформація про діагностику
build_info_diagnostic_title = Інформація про діагностику
build_info_library_restart_hint = * Бібліотеки кодування зображень (HEIF, LibRAW, AVIF) відображають стан на момент запуску - перезавантажте програму після встановлення або видалення плагінів.
build_info_test_file = Тестовий файл
other_apps_title = Інші додатки від qarmin
other_apps_open_source_note = Всі перераховані програми є безкоштовними та з відкритим вихідним кодом.
other_apps_open_button = Відкриті
other_apps_szyszka_desc = Швидке та потужне перейменування файлів.
other_apps_mykrut_desc = Простий швидкий та думка файлового менеджера Linux.
other_apps_dcmki_viewer_desc = Простий глядач DICOM.
other_apps_video_thumbnailer_desc = Обгортка навколо генератора мініатюр відео в Чкавці.
other_apps_space_finder_desc = Простий пошук найбільших файлів у вашій системі.
other_apps_system_info_collector_desc = Збирає використання RAM/CPU з ОС та показує його як графіки.
