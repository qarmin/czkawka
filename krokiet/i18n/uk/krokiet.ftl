...
rust_cannot_load_preset = Не вдалося завантажити налаштування { $preset_idx }, причина: { $reason }
rust_error_moving_to_trash = Error while moving to trash: { $error }
rust_error_removing_file = Помилка при видаленні файлу: { $error }
rust_delete_summary = Видалено пункти { $deleted } для видалення { $failed }
...
rust_hashed_images = Створено зображення { $items_stats } ({ $size_stats })
rust_compared_image_hashes = Порівнявся хеш зображень { $items_stats }
rust_hashed_videos = Створено відео з { $items_stats }
...
rust_found_duplicate_files = Знайдено { $items_found } схожих дублікатів файлів
...
manual_add_button = Ручне додавання
...
tool_invalid_symlinks = Неприпустимі символічні посилання
...
sort_by_parent_name = Сортувати за батьком
...
sort_reverse = Зворотнє сортування
...
subsettings_images_ignore_same_size = Ігнорувати той самий розмір
...
subsettings_videos_ignore_same_size = Ігнорувати той самий розмір
...
subsettings_music_compare_fingerprints_only_with_similar_titles = Порівняти лише з подібними заголовками
...
delete_confirmation = Ви впевнені, що бажаєте видалити виділені елементи?
