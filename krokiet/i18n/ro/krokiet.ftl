...
rust_compared_image_hashes = Comparat cu imaginile { $items_stats }
...
rust_found_duplicate_files = Fișiere duplicate { $items_found } găsite
...
rust_delete_summary = Elemente { $deleted } șterse, au eșuat ștergerea articolelor { $failed } , din toate elementele { $total }
rust_rename_summary = Redenumite elementele { $renamed } , nu s-au putut redenumi elementele { $failed } , din toate articolele { $total }
rust_move_summary = Mutat elementele { $moved } , nu s-a reușit mutarea articolelor { $failed } , din toate elementele { $total }
...
rust_no_files_deleted = Nu s-au selectat fișiere/foldere pentru ștergere
rust_no_files_renamed = Nu s-a selectat niciun fișier/dosar pentru redenumire
rust_no_files_moved = Nu s-a selectat niciun fișier/dosar pentru mutare
rust_delete_confirmation = Sunteţi sigur că doriţi elementele selectate?
rust_delete_confirmation_number_simple = Au fost selectate elemente { $items }.
rust_delete_confirmation_number_groups = Grupurile { $items } articole în { $groups } sunt selectate.
rust_delete_confirmation_selected_all_in_group = În { $groups } grupuri, sunt toate elementele selectate.
...
sort_by_parent_name = Sortează după dosarul părinte
...
sort_by_checked = Sortează după verificarea statusului
