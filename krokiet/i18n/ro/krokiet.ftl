...
motto = Acest program este gratuit și va rămâne întotdeauna așa. Consultați licența MIT/GPL pentru detalii.
...
build_info_build = Construiește
build_info_runtime = Timp de execuție
build_info_refresh = Reîmprospătează
build_info_diagnostic_button = Informații de diagnostic
build_info_diagnostic_title = Informații de diagnostic
build_info_library_restart_hint = * Bibliotecile (HEIF, LibRAW, AVIF) reflectă starea la pornire - reporniți aplicația după instalarea sau dezinstalarea plugin-urilor.
build_info_test_file = Fișier de test
other_apps_title = Alte aplicații ale qarmin
other_apps_open_source_note = Toate aplicațiile listate sunt gratuite și cu sursă deschisă.
other_apps_open_button = Deschideți
other_apps_szyszka_desc = Redenumire de fișiere rapidă și puternică.
other_apps_mykrut_desc = Manager de fişiere Linux simplu şi rapid.
other_apps_dcmki_viewer_desc = Vizualizator DICOM simplu.
other_apps_video_thumbnailer_desc = Wrapper în jurul generatorului de miniaturi video utilizat în Czkawka.
other_apps_space_finder_desc = Găsire simplă a celor mai mari fișiere din sistemul dvs.
other_apps_system_info_collector_desc = Colectează utilizarea RAM/CPU de pe OS și o afișează ca grafice.
