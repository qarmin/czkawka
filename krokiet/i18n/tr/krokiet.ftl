...
rust_checked_images = Kontrol edildi { $items_stats } resim ({ $size_stats })
...
settings_application_scale_hint_text = Elle uygulanan ölçek (örn. 1.0 = %100)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Özellikler bir araya küp şeklinde küçük resimler oluştur, tek bir görüntü yerine (daha uzun sürebilir)
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Öz boyutta grid oluşturmak yerine tek resim oluştur
settings_similar_videos_clear_unused_thumbnails = Kullanılmayan video önizleme dosyalarını 7 günden eski olanları uygulama başlangıcında sil
...
subsettings_video_optimizer_image_threshold = Görüntü eşik değeri
...
optimize_text = Resimleri optimize et
optimize_confirmation_text = Seçilen öğeleri optimize etmekten emin misiniz?
