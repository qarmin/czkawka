...
other_apps_mykrut_desc = Eenvoudige snelle en opinioneerde Linux bestandsbeheer.
other_apps_dcmki_viewer_desc = Eenvoudige DICOM kijker.
other_apps_video_thumbnailer_desc = Omloop de video-thumbnail generator die gebruikt wordt in Czkawka.
...
compare_overlay_text = Overliggende laag
