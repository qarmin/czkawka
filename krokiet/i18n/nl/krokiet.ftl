...
rust_checked_images = Gereset { $items_stats } afbeeldingen ({ $size_stats })
...
settings_application_scale_hint_text = Handmatige schaalingsmethode (bijv. 1.0 = 100%)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Genereer een raster van miniaturen in plaats van één afbeelding (kan langer duren)
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Maak een thumbnail-raster in plaats van één afbeelding genereren
settings_similar_videos_clear_unused_thumbnails = Verwijder ongebruikte videobeschrijvingen ouder dan 7 dagen bij het opstarten van de app
...
subsettings_video_optimizer_image_threshold = Afbeeldingsdrempel
...
optimize_text = Optimaliseer afbeeldingen
optimize_confirmation_text = Ben je zeker dat je de geselecteerde items wilt optimaliseren?
