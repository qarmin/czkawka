...
rust_compared_image_hashes = Vergeleken { $items_stats } afbeeldingshashes
...
rust_found_duplicate_files = Gevonden { $items_found } dubbele bestanden
...
rust_delete_summary = { $deleted } items verwijderd, { $failed } items kunnen niet verwijderd worden uit alle { $total } items
rust_rename_summary = Naam gewijzigd { $renamed } items, niet gelukt om { $failed } items te hernoemen, van alle { $total } items
rust_move_summary = { $moved } items verplaatst, { $failed } items konden niet verplaatst worden, uit alle { $total } items
...
rust_no_files_deleted = Geen enkele bestanden/mappen geselecteerd om te verwijderen
rust_no_files_renamed = Geen enkele bestanden/mappen geselecteerd om te hernoemen
rust_no_files_moved = Geen enkel bestanden/mappen geselecteerd om te verplaatsen
rust_delete_confirmation = Weet u zeker dat u de geselecteerde items wilt hebben?
rust_delete_confirmation_number_simple = { $items } items zijn geselecteerd.
rust_delete_confirmation_number_groups = { $items } items in { $groups } groepen zijn geselecteerd.
rust_delete_confirmation_selected_all_in_group = In { $groups } groepen zijn alle items geselecteerd.
...
sort_by_parent_name = Sorteren op bovenliggende map
...
sort_by_checked = Sorteren op status controleren
