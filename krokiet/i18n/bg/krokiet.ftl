...
rust_checked_images = Проверени { $items_stats } изображения ({ $size_stats })
...
settings_application_scale_hint_text = Ръчно приложна скала (напр. 1.0 = 100%)
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Генерирайте матрица от миниатюри вместо едно изображение (може да отнеме повече време)
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Генериране на мрежа от миниатюри вместо едно изображение
settings_similar_videos_clear_unused_thumbnails = Изтрийте неизползвани видео миниатюри, по-стари от 7 дни при стартиране на приложението
...
subsettings_video_optimizer_image_threshold = Праг на изображение
...
optimize_text = Оптимизиране на изображения
optimize_confirmation_text = Наистина ли искате да оптимизирате избраните елементи?
