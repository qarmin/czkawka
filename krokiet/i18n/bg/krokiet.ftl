...
rust_found_empty_folders = Намерени { $items_found } празни папки в { $time }
rust_found_empty_files = Намерени са { $items_found } празни файла в { $time }
rust_found_similar_images = Намерени са { $items_found } подобни изображения в { $groups } групи за { $time }
rust_found_similar_videos = Намерени са { $items_found } подобни видеофайла в { $groups } групи за { $time }
rust_found_similar_music_files = Намерени са { $items_found } подобни музикални файлове в { $groups } групи за { $time }
rust_found_invalid_symlinks = Намерени { $items_found } невалидни символни свръзки в { $time }
rust_found_temporary_files = Намерени { $items_found } временни файлове за { $time }
rust_no_file_type_selected = Не можете да намерите разбити файлове без избор на вид файл.
rust_found_broken_files = Намерени { $items_found } повредени файлове, заемащи { $size } в { $time }
rust_found_bad_extensions = Намерени са { $items_found } файлове с грешни разширения в { $time }
...
rust_found_duplicate_files = Намерени са { $items_found } дублирани файла в { $groups } групи, заемащи { $size } за { $time }
rust_found_duplicate_files_no_lost_space = Намерени са { $items_found } дублирани файлове в { $groups } групи за { $time }
rust_found_big_files = Намерени { $items_found } големи файлове с размер { $size } за { $time }
rust_found_exif_files = Намерени { $items_found } файла с EXIF данни в { $time }
...
rust_delete_summary = Изтрити { $deleted } елемент(и), неуспешно премахнати { $failed } елемент(и), от общо { $total } елемент(и)
rust_rename_summary = Преименувани { $renamed } елемента, неуспешно преименувани { $failed } елемента, от общо { $total } елемента
rust_move_summary = Преместени { $moved } елемент(и), неуспешно преместени { $failed } елемент(и), от общо { $total } елемент(и)
rust_hardlink_summary = Хардлинковани { $hardlinked } елементи, не успяха да хардлинкат { $failed } елементи, от общо { $total } елементи
...
rust_no_files_deleted = Няма избрани файлове или папки за изтриване
rust_no_files_renamed = Няма избрани файлове или папки за преименуване
rust_no_files_moved = Няма избрани файлове или папки за преместване
rust_no_files_hardlinked = Няма избрани файлове или папки за създаване на твърди връзки
...
rust_delete_confirmation_number_simple = { $items } предмета избрани.
rust_delete_confirmation_number_groups = { $items } елемента са избрани в { $groups } групи.
...
rust_symlink_failed = Неуспешно създаване на символна връзка от { $name } към { $target }, причина { $reason }
...
yes_text = да
no_text = не
do_you_want_to_continue = Желаете ли да продължите?
...
motto = Тази програма е безплатна за използване и винаги ще бъде такава. Вижте лиценза MIT/GPL за повече информация.
unicorn = Може и да не гледате еднорог, но еднорогът винаги ви гледа.
repository = Хранилище
instruction = Инструкции
donation = Дарение
translation = Преводи
other_apps = Други приложения
build_info_build = Версия на компилацията
build_info_runtime = Време за изпълнение
build_info_refresh = Обновете
build_info_diagnostic_button = Информация за диагностика
build_info_diagnostic_title = Информация за диагностика
build_info_library_restart_hint = * Библиотеките за обработка на изображения (HEIF, LibRAW, AVIF) отразяват състоянието при стартиране - рестартирайте приложението след инсталиране или премахване на плъгини.
build_info_test_file = Тестов файл
other_apps_title = Други приложения от qarmin
other_apps_open_source_note = Всички изброени приложения са безплатни и с отворен код.
other_apps_open_button = Отвори
other_apps_szyszka_desc = Бърз и мощен инструмент за преименуване на файлове.
other_apps_mykrut_desc = Прост, бърз и насочен файлов мениджър за Linux.
other_apps_dcmki_viewer_desc = Прост прегледник на DICOM файлове.
other_apps_video_thumbnailer_desc = Опаковка около генератора на миниатюри за видео, използван в Czkawka.
other_apps_space_finder_desc = Прост инструмент за намиране на най-големите файлове във вашата система.
other_apps_system_info_collector_desc = Събира информация за използването на RAM и процесора от операционната система и я визуализира под формата на графики.
...
selection_deselect_all = Премахни избора на всички
...
subsettings_broken_files_markup = Маркъп файлове (JSON/XML/TOML)
...
subsettings_bad_names_space_at_start_end = Интервали в началото/края
...
settings_hide_hard_links_hint = Скрий твърди връзки към еднакви файлове в резултатите
...
settings_video_thumbnails_position = Позиция на миниатюрата във видеото (%)
...
settings_limit_lines_of_messages = Ограничете съобщенията до 500 реда (временно решение за бавния widget TextEdit)
...
settings_audio_env_variable_hint_text = Могат да се променят звуците, като се зададе променливата на околната среда KROKIET_AUDIO_STOP_FILE към валиден път към аудио файл
...
settings_cache_number_size_text = Размер на кеш файловете: { $size }, брой файла: { $number }
settings_video_thumbnails_number_size_text = Размер на видео миниатюрите: { $size }, брой файлове: { $number }
settings_log_number_size_text = Размер на лог файловете: { $size }, брой файлове: { $number }
...
subsettings_video_optimizer_crop_type = Тип изрязване
...
subsettings_video_optimizer_black_bar_min_percentage = Минимален процент чернота на лентата
...
subsettings_video_optimizer_max_samples = Макс. брой кадри
subsettings_video_optimizer_max_samples_hint = Максимален брой кадри за анализ на видео (5-1000). По подразбиране: 60
subsettings_video_optimizer_min_crop_size = Минимален размер на изрязване
...
subsettings_video_optimizer_noise_reduction_strength = NR Сила
subsettings_video_optimizer_use_custom_command = Използвайте персонализирана команда на FFmpeg
subsettings_video_optimizer_custom_command_hint = Команда с { "{PATH}" } за входния файл. Изходният път се добавя автоматично.
subsettings_video_optimizer_hardware_encoder = Хардуерен кодер
subsettings_video_optimizer_generate_template = Генериране на шаблон
subsettings_reset = Нулирай
...
hardlink_button_text = Твърда връзка
...
softlink_button_text = Символна връзка
softlink_text = Създай символични връзки
softlink_confirmation_text = Наистина ли искате да създадете символни връзки (symlinks) за избраните елементи?
...
compare_overlay_text = Наслагване
compare_loading_title_text = Моля, изчакайте...
compare_cancel_text = Отказ
compare_resolution_mismatch_text = Различни резолюции - резултатите от сравнението може да са неточни
...
context_menu_open_item_text = Отвори елемента
...
context_menu_exclude_item_text = Изключи елемента
