...
rust_found_similar_images = Foram encontrados ‘{ $items_found }’ arquivos de imagem semelhantes nos ‘{ $groups }’ grupos. A verificação durou ‘{ $time }’
rust_found_similar_videos = Foram encontrados ‘{ $items_found }’ arquivos de vídeo semelhantes nos ‘{ $groups }’ grupos. A verificação durou ‘{ $time }’
rust_found_similar_music_files = Foram encontrados ‘{ $items_found }’ arquivos de música semelhantes nos ‘{ $groups }’ grupos. A verificação durou ‘{ $time }’
...
rust_found_bad_names = Foram encontrados ‘{ $items_found }’ arquivos com nomes problemáticos. A verificação durou ‘{ $time }’
...
rust_cannot_load_preset = Não foi possível carregar e alterar a predefinição ‘{ $preset_idx }’ por causa de ‘{ $reason }’, portanto, serão utilizadas as configurações padrão
...
rust_move_summary = Foram movidos ‘{ $moved }’ itens, ocorreu uma falha ao mover ‘{ $failed }’ itens de ‘{ $total }’ itens
...
rust_trash_confirmation_unsupported_volumes = Nota: nem todos os volumes são compatíveis com a movimentação de arquivos para a lixeira. Nos volumes não compatíveis, esta operação sempre falhará.
rust_trash_confirmation_number_simple = Foram selecionados ‘{ $items }’ itens.
rust_trash_confirmation_number_groups = Foram selecionados ‘{ $items }’ itens nos ‘{ $groups }’ grupos.
rust_trash_confirmation_selected_all_in_group = Todos os itens foram selecionados nos ‘{ $groups }’ grupos.
...
column_proper_extension = Extensão correta
column_fps = FPS
column_codec = Codec
...
motto = Este programa é gratuito para uso e sempre será. Consulte a Licença MIT/GPL para obter detalhes.
...
build_info_library_restart_hint = * As bibliotecas (HEIF, LibRAW, AVIF) refletem o estado no momento da inicialização - reinicie o aplicativo após instalar ou remover plugins.
build_info_test_file = Arquivo de Teste
other_apps_title = Outros aplicativos de qarmin
other_apps_open_source_note = Todos os aplicativos listados são gratuitos e em código aberto.
other_apps_open_button = Abertas
other_apps_szyszka_desc = Renomeador de arquivos rápido e poderoso.
other_apps_mykrut_desc = Gerenciador de arquivos Linux simples e rápido e com opinião.
...
other_apps_space_finder_desc = Localizador simples dos maiores arquivos no seu sistema.
...
selection_all_except_longest_path = Selecionar todas as opções, exceto o caminho mais longo
selection_all_except_shortest_path = Selecionar todas as opções, exceto o caminho mais curto
...
option_search_mode_biggest = O arquivo maior
option_search_mode_smallest = O arquivo menor
...
subsettings_videos_audio_preset_custom = Regras personalizadas
...
subsettings_videos_visual_preset_custom = Regras personalizadas
...
subsettings_music_approximate_comparison = Comparação aproximada das tags
...
subsettings_music_compare_fingerprints_only_with_similar_titles = Comparar nos grupos por títulos semelhantes
...
settings_similar_videos_tool = Ferramenta de vídeos semelhantes
...
settings_similar_images_tool = Ferramenta de imagens semelhantes
...
settings_select_group_date_text = Data da modificação
...
settings_play_audio_on_scan_completion_text = Reproduzir um efeito sonoro quando uma pesquisa for concluída com sucesso
...
settings_video_thumbnails_number_size_text = Tamanho das miniaturas dos vídeos: ‘{ $size }’, quantidade de arquivos: ‘{ $number }’
...
subsettings_exif_ignored_tags_hint_text = Lista de tags separadas por vírgulas para excluir da verificação (por exemplo, GPS, Thumbnail ou Miniatura). Algumas tags, como ‘ImageWidth’ (largura da imagem) nos arquivos TIFF, são ocultadas para evitar que o arquivo da imagem seja corrompido.
...
hardlink_button_text = Vínculo físico
hardlink_text = Criar os vínculos físicos
...
popup_custom_case_sensitive_text = Diferenciar entre maiúsculas e minúsculas
...
compare_diff_text = Diferença
compare_split_text = Divisão
compare_overlay_text = Sobreposição
