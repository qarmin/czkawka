...
rust_checked_images = Verificados { $items_stats } imagens ({ $size_stats })
...
rust_hardlink_summary = Itens hardlinked { $hardlinked }, falharam em hardlink { $failed }, de { $total } itens
rust_symlink_summary = Simlinkados { $symlinked } itens, falhou em simlinkar { $failed } itens, de um total de { $total } itens
rust_optimize_video_summary = Vídeos otimizados { $optimized }, vídeos que não otimizaram { $failed }, fora de { $total } vídeos
rust_clean_exif_summary = Limpeza EXIF de { $cleaned } arquivos, falhou na limpeza de { $failed } arquivos, de um total de { $total } arquivos
...
rust_symlinking_no_size_files = Simlinkando o arquivo { $items_stats }
...
rust_move_confirmation = Tem certeza que deseja mover os itens selecionados?
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image_hint_text = Gere uma grade de miniaturas em vez de uma única imagem (pode demorar mais)
...
settings_similar_videos_clear_unused_thumbnails = Excluir miniaturas de vídeo não utilizadas com mais de 7 dias no início do aplicativo
move_confirmation_text = Tem certeza que deseja mover os itens selecionados?
...
subsettings_video_optimizer_image_threshold = limiar da imagem
subsettings_reset = Redefinir
subsettings_exif_ignored_tags_text = Ignorados tags:
subsettings_exif_ignored_tags_hint_text = Lista separada por vírgulas de tags para excluir da varredura (por exemplo, GPS, Miniatura). Algumas tags, como ImageWidth em arquivos TIFF, são ocultas para evitar quebrar a imagem.
...
softlink_text = Criar links simbólicos
softlink_confirmation_text = Tem certeza que deseja criar links simbólicos (softlinks) para os itens selecionados?