...
rust_compared_image_hashes = Comparado a { $items_stats } hashes de imagens
...
rust_found_duplicate_files = Encontrados { $items_found } arquivos duplicados
...
rust_delete_summary = { $deleted } itens excluídos, falhou em remover os itens de { $failed } de todos os { $total } itens
rust_rename_summary = Renomeado { $renamed } itens, falhou em renomear itens { $failed } de todos os { $total } itens
rust_move_summary = Mover itens { $moved } , falhou em mover itens de { $failed } de todos os { $total }
...
rust_no_files_deleted = Não selecionado nenhum arquivo/pasta para excluir
rust_no_files_renamed = Nenhum arquivo/pasta não selecionado para renomear
rust_no_files_moved = Não selecionado nenhum arquivo/pasta para mover
rust_delete_confirmation = Você tem certeza que deseja os itens selecionados?
rust_delete_confirmation_number_simple = { $items } itens estão selecionados.
rust_delete_confirmation_number_groups = { $items } itens em { $groups } grupos estão selecionados.
rust_delete_confirmation_selected_all_in_group = Em { $groups } grupos, existem todos os itens selecionados.
...
sort_by_parent_name = Ordenar por pasta pai
...
sort_by_checked = Ordenar por status de verificação
