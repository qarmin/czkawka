...
optimize_fail_if_bigger_text = Niepowodzenie jeśli zoptymalizowany plik jest większy
optimize_overwrite_files_text = Nadpisz pliki
optimize_limit_video_size_text = Ogranicz rozmiar wideo
optimize_max_width_text = Maks. szerokość:
optimize_max_height_text = Maks. wysokość:
