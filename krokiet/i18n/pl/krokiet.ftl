...
subsettings_iv_optimizer_mode = Tryb
subsettings_iv_optimizer_video_codec = Kodek wideo
subsettings_iv_optimizer_excluded_codecs = Wykluczone kodeki
subsettings_iv_optimizer_video_quality = Jakość wideo (CRF)
subsettings_iv_optimizer_image_threshold = Próg obrazu
subsettings_reset = Resetuj
subsettings_exif_ignored_tags_text = Ignorowane tagi (oddzielone przecinkami):
subsettings_exif_ignored_tags_hint_text = Tagi do wykluczenia ze skanowania (np. GPS, Thumbnail, MakerNote)
...
hardlink_text = Utwórz hardlinki
hardlink_confirmation_text = Czy na pewno chcesz utworzyć hardlinki dla wybranych elementów?
softlink_button_text = Softlink
softlink_text = Utwórz softlinki
softlink_confirmation_text = Czy na pewno chcesz utworzyć softlinki (dowiązania symboliczne) dla wybranych elementów?
