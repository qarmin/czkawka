...
subsettings_video_optimizer_black_bar_min_percentage_hint = Minimalny procent czarnych pikseli w rzędzie/kolumnie, aby był uznany za czarny pasek (0-100). Domyślnie: 90
