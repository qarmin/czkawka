...
rust_compared_image_hashes = Porównanie { $items_stats } hashów obrazu
...
rust_found_duplicate_files = Znaleziono duplikaty { $items_found }
...
rust_delete_summary = Usunięto { $deleted } elementy, nie udało się usunąć { $failed } elementów, ze wszystkich elementów { $total }
rust_rename_summary = Zmieniono nazwę { $renamed } elementów, nie udało się zmienić nazwy { $failed } elementów, z wszystkich elementów { $total }
rust_move_summary = Przeniesiono { $moved } elementy, nie udało się przenieść { $failed } z wszystkich elementów { $total }
...
rust_no_files_deleted = Nie wybrano żadnych plików/folderów do usunięcia
rust_no_files_renamed = Nie wybrano żadnych plików/folderów do zmiany nazwy
rust_no_files_moved = Nie wybrano żadnych plików/folderów do przeniesienia
rust_delete_confirmation = Czy na pewno chcesz wybrać wybrane elementy?
rust_delete_confirmation_number_simple = Wybrano elementy { $items }.
rust_delete_confirmation_number_groups = Wybrano elementy { $items } w grupach { $groups }.
rust_delete_confirmation_selected_all_in_group = W grupach { $groups } są wybrane wszystkie pozycje.
...
sort_by_parent_name = Sortuj według folderu nadrzędnego
...
sort_by_checked = Sortuj według statusu sprawdzania
