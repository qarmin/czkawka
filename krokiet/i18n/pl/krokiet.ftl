...
rust_delete_confirmation_number_simple = Wybrano elementy { $items }.
rust_delete_confirmation_number_groups = { $items } elementów wybranych w grupach { $groups }.
rust_delete_confirmation_selected_all_in_group = Wszystkie elementy wybrane w grupach { $groups }.
...
popup_rename_message = To zmieni nazwę rozszerzeń wybranych plików na bardziej odpowiednie
...
subsettings_videos_crop_detect = Przytnij metodę wykrywania
...
rust_checked_images = Sprawdzone { $items_stats } obrazy ({ $size_stats })
rust_checked_videos = Sprawdzone { $items_stats } wideo ({ $size_stats })
...
rust_hardlink_summary = Zwiążone twardo { $hardlinked } elementy, nie udało się zawiązać twardo { $failed } elementów, spośród { $total } elementów
rust_symlink_summary = Symlinked { $symlinked } elementów, nie udało się symlinkować { $failed } elementów, z { $total } elementów
rust_optimize_video_summary = Zoptymalizowane { $optimized } wideo, nie zoptymalizowane { $failed } wideo, spośród { $total } wideo
rust_clean_exif_summary = Oczyściłem EXIF z { $cleaned } plików, nie udało się wyczyścić { $failed } plików, z { $total } plików.
rust_hardlinking_files = Hardlinking { $items_stats } plik ({ $size_stats })
rust_hardlinking_no_size_files = Hardlinking { $items_stats } plik
rust_symlinking_files = Symlinking plik { $items_stats } ({ $size_stats})
rust_symlinking_no_size_files = Symlinking { $items_stats } plik
rust_optimizing_videos = Zoptymalizowany { $items_stats } wideo ({ $size_stats })
rust_optimizing_no_size_videos = Zoptymalizowany { $items_stats } wideo
...
rust_extracted_exif_tags = Wyodrębnione tagi EXIF z plików { $items_stats } ({ $size_stats })
rust_move_confirmation = Czy na pewno chcesz przenieść wybrane elementy?
rust_move_confirmation_number_simple = { $items } elementów wybrane.
rust_clean_exif_confirmation = Czy na pewno chcesz usunąć dane EXIF z wybranych elementów?
rust_clean_exif_confirmation_number_simple = { $items } elementów wybrane.
...
rust_optimize_video_confirmation_number_simple = { $items } elementów wybrane.
rust_hardlink_confirmation = Czy na pewno chcesz utworzyć twarde linki dla wybranych elementów?
rust_hardlink_confirmation_number_simple = { $items } elementów wybrano.
rust_symlink_confirmation = Czy na pewno chcesz utworzyć symlinki dla wybranych elementów?
rust_symlink_confirmation_number_simple = { $items } elementów wybrano.
rust_rename_confirmation = Czy na pewno chcesz przekształcić wybrane elementy?
rust_rename_confirmation_number_simple = { $items } elementów wybrano.
...
settings_similar_videos_generate_thumbnail_grid_instead_of_single_image = Wygeneruj siatkę miniatur zamiast pojedynczej grafiki
...
rename_confirmation_text = Czy na pewno chcesz przekształcić wybrane elementy?
...
subsettings_exif_ignored_tags_hint_text = Lista oddzielona przecinkami tagów do wykluczenia z skanowania (np. GPS, Miniatura). Niektóre tagi, takie jak ImageWidth w plikach TIFF, są ukryte, aby zapobiec uszkodzeniu obrazu.
clean_button_text = Czysto
clean_text = Czyste dane EXIF
...
optimize_fail_if_bigger_text = Pominięcie, jeśli plik zoptymalizowany jest większy
