...
subsettings_bad_names_issues = Sprawdzanie nazw
subsettings_bad_names_uppercase_extension = Wielkie litery w rozszerzeniu
subsettings_bad_names_uppercase_extension_hint = Znajduje pliki z wielkimi literami w rozszerzeniu (np. .JPG, .Mp3) i proponuje wersję z małymi literami
subsettings_bad_names_emoji_used = Emoji w nazwie
subsettings_bad_names_emoji_used_hint = Znajduje pliki ze znakami emoji (😀, 🎉, itp.) w nazwie i proponuje ich usunięcie
subsettings_bad_names_space_at_start_end = Spacje na początku/końcu
subsettings_bad_names_space_at_start_end_hint = Znajduje pliki ze spacjami na początku lub końcu nazwy i proponuje ich usunięcie
subsettings_bad_names_non_ascii = Znaki spoza ASCII
subsettings_bad_names_non_ascii_hint = Znajduje znaki spoza ASCII (ą, ć, ñ, itp.) i proponuje zamianę na odpowiedniki ASCII (a, c, n) lub usunięcie, jeśli brak mapowania
subsettings_bad_names_restricted_charset = Ograniczony zestaw znaków
subsettings_bad_names_restricted_charset_hint = Transliteruje znaki spoza ASCII na ASCII, następnie znajduje pliki zawierające znaki spoza 0-9a-zA-Z i zdefiniowanych przez użytkownika dozwolonych znaków
subsettings_bad_names_allowed_chars = Dozwolone znaki
subsettings_bad_names_remove_duplicated = Zduplikowane znaki
subsettings_bad_names_remove_duplicated_hint = Znajduje kolejne zduplikowane znaki niealfanumeryczne (np. "plik---nazwa..txt") i proponuje usunięcie duplikatów
