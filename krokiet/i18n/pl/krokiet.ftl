...
rust_found_empty_folders = Znaleziono puste foldery { $items_found } w { $time }
rust_found_empty_files = Znaleziono { $items_found } puste pliki w { $time }
rust_found_similar_images = Znaleziono { $items_found } podobne pliki obrazów w grupach { $groups } w { $time }
...
rust_found_temporary_files = Znaleziono pliki tymczasowe { $items_found } w { $time }
...
rust_found_bad_extensions = Znaleziono pliki { $items_found } z niepoprawnymi rozszerzeniami w { $time }
rust_found_duplicate_files = Znaleziono zduplikowane pliki { $items_found } w grupach { $groups } i { $size } w { $time }
