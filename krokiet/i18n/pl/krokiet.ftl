...
subsettings_video_optimizer_black_pixel_threshold_hint = Maksymalna wartość RGB dla piksela, aby był uznany za czarny (0-255). Domyślnie: 20
subsettings_video_optimizer_black_bar_min_percentage = Minimalny procent czarnego paska
subsettings_video_optimizer_black_bar_min_percentage_hint = Minimalny procent czarnych pikseli w rzędzie/kolumnie, aby był uznany za czarny pasek (0.0-1.0). Domyślnie: 0.9
subsettings_video_optimizer_max_samples = Maksymalna liczba próbek
subsettings_video_optimizer_max_samples_hint = Maksymalna liczba klatek do analizy na wideo. Domyślnie: 60
subsettings_video_optimizer_min_crop_size = Minimalny rozmiar przycięcia
subsettings_video_optimizer_min_crop_size_hint = Minimalna liczba pikseli do przycięcia z każdej strony. Mniejsze przycięcia są ignorowane. Domyślnie: 5
