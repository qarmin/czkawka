...
pub enum CurrentStage {
    ...
    SimilarDocumentsHashing,
    SimilarDocumentsComparing,
    BrokenFilesChecking,
...
impl ProgressData {
    pub(crate) fn validate(&self) {
        ...
        let tool_type_current_stage: Option<ToolType> = match self.sstage {
            ...
            CurrentStage::SimilarDocumentsHashing | CurrentStage::SimilarDocumentsComparing => Some(ToolType::SimilarDocuments),
...
impl ToolType {
    pub(crate) fn get_max_stage(self, checking_method: CheckingMethod) -> u8 {
        match self {
            ...
            Self::SimilarImages | Self::SimilarVideos | Self::VideoOptimizer | Self::SimilarDocuments => 2,
            Self::ExifRemover => 3,
...
impl CurrentStage {
    ...
    pub fn get_current_stage(self) -> u8 {
        ...
        match self {
            ...
            Self::SimilarDocumentsHashing => 1,
            Self::SimilarDocumentsComparing => 2,
