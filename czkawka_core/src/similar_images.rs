...
pub fn get_string_from_similarity(similarity: &Similarity, hash_size: u8) -> String {
    ...
    match similarity {
        ...
        Similarity::Similar(h) => {
            ...
            //         format!("{} {}", fl2!("core_similarity_very_high"), *h)
            //     } else if *h <= SIMILAR_VALUES[index_preset][1] {
            //         format!("{} {}", fl2!("core_similarity_high"), *h)
            //     } else if *h <= SIMILAR_VALUES[index_preset][2] {
            //         format!("{} {}", fl2!("core_similarity_medium"), *h)
            //     } else if *h <= SIMILAR_VALUES[index_preset][3] {
            //         format!("{} {}", fl2!("core_similarity_small"), *h)
            //     } else if *h <= SIMILAR_VALUES[index_preset][4] {
            //         format!("{} {}", fl2!("core_similarity_very_small"), *h)
            //     } else if *h <= SIMILAR_VALUES[index_preset][5] {
            //         format!("{} {}", fl2!("core_similarity_minimal"), *h)
            //     } else {
            //         panic!();
            //     }
            // }
            ...
            {
                if *h <= SIMILAR_VALUES[index_preset][0] {
                    fl2!("core_similarity_very_high")
                } else if *h <= SIMILAR_VALUES[index_preset][1] {
                    fl2!("core_similarity_high")
                } else if *h <= SIMILAR_VALUES[index_preset][2] {
                    fl2!("core_similarity_medium")
                } else if *h <= SIMILAR_VALUES[index_preset][3] {
                    fl2!("core_similarity_small")
                } else if *h <= SIMILAR_VALUES[index_preset][4] {
                    fl2!("core_similarity_very_small")
                } else if *h <= SIMILAR_VALUES[index_preset][5] {
                    fl2!("core_similarity_minimal")
                } else {
                    panic!();
                }
            }
