...
use crate::tools::similar_videos::{
    ...
    DEFAULT_DURATION_TOLERANCE_PCT, DEFAULT_FFMPEG_TIMEOUT_SECONDS, DEFAULT_MIN_MATCHING_WINDOWS, DEFAULT_SUBCLIP_MIN_MATCH, DEFAULT_WINDOW_COUNT, SimilarVideos,
    SimilarVideosParameters,
};
