...
core_excluded_items_wildcard_required = Cu excepţia articolelor Avertisment: Wildcard * este necesar în expresie, ignorând { $expression }
...
core_hardlink_unsupported_filesystem = Sistemul de fişiere de la "{ $path }" nu suportă link-uri hard ({ $reason })
...
core_properly_loaded_cache_entries = Intrările de cache sunt încărcate corespunzător { $count }.
...
core_ffmpeg_unknown_encoder = Nu se poate codifica { $file } folosind codificatorul { $encoder }. Versiunea curentă a FFmpeg nu suportă acest codificator. Utilizaţi o altă versiune de FFmpeg cu suportul necesar pentru codec sau selectaţi un alt codificator.
core_ffmpeg_error = Eroare FFmpeg în timpul procesării { $file }, cod de stare { $code }, motiv { $reason }
core_custom_command_missing_path_placeholder = Comanda personalizată FFmpeg trebuie să conțină { "{PATH}" } ca substituent al fișierului
core_custom_command_empty = Comanda personalizată FFmpeg nu poate fi goală
# Scan stage labels
# Collecting / scanning files (the { $entries_checked } counter grows while the disk is walked)
stage_collecting_files = Scanare { $entries_checked } fişier
stage_collecting_folders = Se scanează dosarul { $entries_checked }
stage_scanning_name = Se scanează numele { $entries_checked } fişier
stage_scanning_size_name = Se scanează dimensiunea și denumirea fișierului { $entries_checked }
stage_scanning_size = Dimensiune scanare { $entries_checked } fişier
# Cache load/save (indeterminate, no counters)
stage_filtering_outdated_cache = Filtrează intrările învechite
stage_loading_prehash_cache = Se încarcă cache-ul prehash
stage_saving_prehash_cache = Salvare cache prehash
stage_loading_hash_cache = Încărcare cache hash
stage_saving_hash_cache = Salvare cache hash
stage_loading_tags_cache = Se încarcă cache-ul etichetelor
stage_saving_tags_cache = Salvare cache etichete
stage_loading_fingerprints_cache = Se încarcă cache-ul amprentelor
stage_saving_fingerprints_cache = Salvare cache amprente
stage_loading_exif_cache = Încărcare cache EXIF
stage_saving_exif_cache = Salvare cache EXIF
# Per-tool work stages - items_stats holds "checked/total", size_stats holds the byte sizes
stage_hiding_links = Ascunzând link-urile hard { $items_stats }
stage_analyzed_partial_hash = Anzed partial hash of { $items_stats } files ({ $size_stats })
stage_analyzed_full_hash = Analizat complet hash of { $items_stats } fişiere ({ $size_stats })
stage_checked_tags = Tag-uri verificate din { $items_stats }
stage_compared_tags = Etichete comparate din { $items_stats }
stage_checked_content = Conținut verificat din { $items_stats } ({ $size_stats })
stage_compared_content = Comparativ cu conţinutul { $items_stats }
stage_hashed_images = Hashed { $items_stats } imagini ({ $size_stats })
stage_compared_image_hashes = Comparated image hashes of { $items_stats }
stage_hashed_videos = Hashed { $items_stats } videoclipuri
stage_created_thumbnails = Miniaturi create pentru { $items_stats } videoclipuri
stage_checked_videos = Verificat { $items_stats } videoclipuri ({ $size_stats })
stage_extracted_exif_tags = Extragerea etichetelor EXIF din fișierele { $items_stats } ({ $size_stats })
stage_checked_files = S-a verificat fișierul { $items_stats } ({ $size_stats })
stage_checked_files_bad_extensions = Verificat { $items_stats } fișier
stage_checked_files_bad_names = Verificat { $items_stats } fișier
stage_checking_empty_files_content = Verificarea conţinutului din { $items_stats } fişiere ({ $size_stats })
# File operations (delete/rename/move/...); the "no_size" variant is used when no byte total is known
stage_deleting_files = Ştergerea fişierului { $items_stats } ({ $size_stats })
stage_deleting_no_size_files = Ştergerea fişierului { $items_stats }
stage_renaming_files = Redenumiţi fişierul { $items_stats }
stage_moving_files = Moving { $items_stats } file ({ $size_stats})
stage_moving_no_size_files = Se mută { $items_stats } fișier
stage_hardlinking_files = Hardlinking { $items_stats } fișier ({ $size_stats })
stage_hardlinking_no_size_files = Hardlinking { $items_stats } fișier
stage_symlinking_files = Simulare de legătură către fișier { $items_stats } ({ $size_stats })
stage_symlinking_no_size_files = Simulare a fiuncționalului fișierul { $items_stats }
stage_optimizing_videos = Video optimizat { $items_stats } ({ $size_stats })
