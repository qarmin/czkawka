...
core_excluded_items_wildcard_required = Articoli esclusi Attenzione: Wildcard * è richiesto in espressione, ignorando { $expression }
...
core_hardlink_unsupported_filesystem = Il filesystem di "{ $path }" non supporta i collegamenti hard ({ $reason })
...
core_properly_loaded_cache_entries = Voci cache correttamente caricate { $count }.
...
core_ffmpeg_unknown_encoder = Impossibile codificare { $file } usando il codificatore { $encoder }. La generazione attuale di FFmpeg non supporta questo codificatore. Usa una diversa versione FFmpeg con il supporto codec richiesto o seleziona un altro encoder.
...
stage_collecting_files = Processando { $entries_checked } file
stage_collecting_folders = Verificando { $entries_checked } cartelle
stage_scanning_name = Leggendo il nome di { $entries_checked } file
stage_scanning_size_name = Scansione dimensione e nome del file { $entries_checked }
stage_scanning_size = Leggendo le dimensioni di { $entries_checked } file
...
stage_hiding_links = Nascondere i collegamenti duri { $items_stats }
stage_analyzed_partial_hash = Hash parziale analizzato dei file { $items_stats } ({ $size_stats })
stage_analyzed_full_hash = Hash completo analizzato dei file { $items_stats } ({ $size_stats })
...
stage_hashed_videos = Hashed { $items_stats } video
stage_created_thumbnails = Miniature create per i video { $items_stats }
...
stage_checked_files = File { $items_stats } verificato ({ $size_stats })
stage_checked_files_bad_extensions = File { $items_stats } verificato
stage_checked_files_bad_names = File { $items_stats } verificato
stage_checking_empty_files_content = Verifica del contenuto dei file { $items_stats } ({ $size_stats })
...
stage_deleting_no_size_files = Eliminazione del file { $items_stats }
stage_renaming_files = Rinomina del file { $items_stats }
stage_moving_files = Moving { $items_stats } file ({ $size_stats})
stage_moving_no_size_files = Spostamento del file { $items_stats }
stage_hardlinking_files = Hardlinking { $items_stats } file ({ $size_stats})
stage_hardlinking_no_size_files = Collegamento stretto { $items_stats } file
stage_symlinking_files = Symlinking { $items_stats } file ({ $size_stats})
stage_symlinking_no_size_files = Simvolico { $items_stats } file
stage_optimizing_videos = Video ottimizzato { $items_stats } ({ $size_stats })
stage_optimizing_no_size_videos = Video ottimizzato { $items_stats }
stage_cleaning_exif = Pulire EXIF da { $items_stats } file ({ $size_stats })
stage_cleaning_no_size_exif = Pulire EXIF da { $items_stats } file
