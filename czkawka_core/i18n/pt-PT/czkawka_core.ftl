...
core_failed_to_check_process_status = Falhou ao verificar o status do processo: { $razão }
core_failed_to_wait_for_process = Falhou ao aguardar o processo: { $razão }
core_failed_to_read_video_properties = Falhou ao ler as propriedades do vídeo: { $razão }
core_failed_to_execute_ffmpeg = Falhou ao executar ffmpeg: { $razão }
...
core_folder_does_not_exist = A pasta não existe: { $pasta }
