...
core_similarity_minimal = مینیمال
...
core_messages_limit_reached_lines = تعداد پیام‌ها حاشیه مقرر ({ $current }/{ $limit } خط) را بیشینه کرد، بنابراین خروجی کوتاه شده است. برای مطالعه خروجی کامل، گزینه محدود کردن را در تنظیمات غیرفعال کنید.
