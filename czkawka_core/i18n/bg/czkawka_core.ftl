...
core_similarity_very_small = Много малко
core_similarity_minimal = Минимално
core_cannot_open_dir = Не може да се отвори папка { $dir }, причината е { $reason }
core_cannot_read_entry_dir = Не може да се прочете запис в папка { $dir }, причината е { $reason }
core_cannot_read_metadata_dir = Не могат да се прочетат мета-данните в папка { $dir }, причината е { $reason }
core_cannot_read_metadata_file = Не могат да бъдат прочетени метаданните на файла { $file }, причина { $reason }
core_file_modified_before_epoch = Файлът { $name } изглежда е бил променен преди Unix епохата
core_folder_modified_before_epoch = Папката { $name } изглежда е била променена преди Unix епохата
...
core_missing_no_chosen_included_path = Не е избран валиден включен път (изключените пътища биха могли да са изключили всички включени пътища)
...
core_must_be_directory_or_file = Предоставеният път трябва да сочи валидна директория или файл, пренебрегвайки { $path }
...
core_needs_to_set_at_least_one_broken_option = Не може да се стартира сканиране, когато не е зададена опция за сканиране на повредени файлове
...
core_ffmpeg_not_found_windows = Бъдете сигурни, че ffmpeg.exe и ffprobe.exe са налични в PATH или са разположени директно в същата папка като изпълнимия файл на приложението
core_invalid_symlink_infinite_recursion = Безкрайна рекурсия
core_invalid_symlink_non_existent_destination = Несъществуващ целеви файл
core_messages_limit_reached_characters = Броят на съобщенията надвиши зададения лимит ({ $current }/{ $limit } знака), затова изходът беше съкратен. За да прочетете пълния изход, изключете опцията за ограничаване в настройките.
core_messages_limit_reached_lines = Броят на съобщенията надвиши зададения лимит ({ $current }/{ $limit } реда), затова изходът беше съкратен. За да прочетете пълния изход, изключете опцията за ограничаване в настройките.
core_error_moving_to_trash = Грешка при преместване на "{ $file }" в кош: { $error }
core_error_removing = Грешка при изтриване на "{ $file }": { $error }
core_hardlink_unsupported_filesystem = Файловата система на "{ $path }" не поддържа твърди връзки ({ $reason })
core_no_similarity_method_selected = Не можете да намерите подобни музикални файлове без избран метод за сходство
core_failed_to_spawn_command = Не успях да стартирам командата: { $reason }
...
core_cropped_video_not_created = Изрязаният видео файл не беше създаден: { $temp }
...
core_video_width_exceeds_limit = Видео ширина { $width } надхвърля лимита от { $limit }
...
core_unknown_exif_tag_group = Неизвестна група EXIF тагове: { $tag }
...
core_image_file_too_large = Файлът с изображение е твърде голям ({ $size } байта) - надвишава лимита от { $limit } MB
...
core_failed_to_write_data_to_cache = Не може да се запишат данни в кеш файла "{ $file }", причина { $reason }
...
core_failed_to_crop_video = Не успях да изрежа видеото "{ $file }": { $reason }
...
core_invalid_extension_contains_space = { $extension } не е валидно разширение, защото съдържа празно пространство вътре
core_invalid_extension_contains_dot = { $extension } не е валидно разширение, защото съдържа точка вътре
core_ffmpeg_unknown_encoder = Не може да се кодира файлът { $file } с кодировача { $encoder }. Текущата версия на FFmpeg не поддържа този кодировач. Използвайте друга версия на FFmpeg с поддръжка на необходимия кодек или изберете друг кодировач.
core_ffmpeg_error = Грешка при обработката на файла { $file } с FFmpeg, код на грешката: { $code }, причина: { $reason }
core_custom_command_missing_path_placeholder = Персонализираната команда на FFmpeg трябва да съдържа { "{PATH}" } като placeholder за входния файл
...
stage_scanning_name = Сканиране на името на { $entries_checked } файл
...
stage_loading_exif_cache = Зареждане на EXIF кеш
stage_saving_exif_cache = Запис на EXIF кеш
...
stage_compared_image_hashes = Сравнени хешовете на изображенията от { $items_stats }
stage_hashed_videos = Хеширани { $items_stats } видеа
stage_created_thumbnails = Създадени миниатюри за { $items_stats } видеа
...
stage_checked_files_bad_names = Проверени { $items_stats } файла (с неподходящо име)
stage_checking_empty_files_content = Проверява се съдържанието на { $items_stats } файла ({ $size_stats })
...
stage_hardlinking_no_size_files = Хардлинкинг { $items_stats } файл
stage_symlinking_files = Символно свързване на { $items_stats } файл ({ $size_stats })
