...
core_file_modified_before_epoch = Файл { $name } был изменён до начала эпохи Unix
core_folder_modified_before_epoch = Папка { $name } была изменена до начала эпохи Unix
...
core_must_be_directory_or_file = Указанный путь должен вести к существующему каталогу или файлу, { $path } игнорируется
...
core_excluded_items_wildcard_required = Предупреждение об исключённых элементах: в выражении требуется символ *, { $expression } игнорируется
...
core_needs_to_set_at_least_one_broken_option = Невозможно начать сканирование: не выбрано ни одного типа повреждённых файлов для проверки
core_needs_to_set_at_least_one_bad_name_option = Невозможно начать сканирование: не выбрано ни одного критерия плохого имени
core_ffmpeg_not_found = Не удаётся найти подходящую установку FFmpeg или FFprobe. Это внешние программы, которые необходимо установить вручную.
...
core_hardlink_unsupported_filesystem = Файловая система в «{ $path }» не поддерживает жёсткие ссылки ({ $reason })
...
core_video_file_does_not_exist = Видеофайл не существует (возможно, удалён между сканированием и последующими шагами): «{ $path }»
...
core_properly_saved_cache_entries = В файл успешно сохранено { $count } записей кэша.
core_properly_loaded_cache_entries = Успешно загружено { $count } записей кэша.
...
core_ffmpeg_unknown_encoder = Невозможно закодировать { $file } с использованием кодека { $encoder }. Текущая сборка FFmpeg не поддерживает этот кодировщик. Используйте другую версию FFmpeg с необходимой поддержкой кодека или выберите другой кодировщик.
core_ffmpeg_error = Ошибка FFmpeg при обработке { $file }, код статуса { $code }, причина { $reason }
core_custom_command_missing_path_placeholder = Пользовательская команда FFmpeg должна содержать { "{PATH}" } как заполнитель входного файла
core_custom_command_empty = Пользовательская команда FFmpeg не может быть пустой
# Scan stage labels
# Collecting / scanning files (the { $entries_checked } counter grows while the disk is walked)
stage_collecting_files = Сканирование файлов: { $entries_checked }
stage_collecting_folders = Сканирование папки { $entries_checked }
stage_scanning_name = Сканирование имён файлов: { $entries_checked }
stage_scanning_size_name = Сканирование размера и имён файлов: { $entries_checked }
stage_scanning_size = Сканирование размера файлов: { $entries_checked }
...
stage_hiding_links = Скрытие жёстких ссылок { $items_stats }
...
stage_created_thumbnails = Создано миниатюр для видео: { $items_stats }
...
stage_checked_files_bad_extensions = Проверено файлов: { $items_stats }
stage_checked_files_bad_names = Проверено файлов: { $items_stats }
...
stage_renaming_files = Переименование { $items_stats } файлов
