...
core_excluded_items_wildcard_required = Avertissement sur les articles exclus : Les caractères génériques * sont requis dans l'expression, ignorant { $expression }
...
core_properly_loaded_cache_entries = Entrée de cache { $count } correctement chargée.
...
stage_loading_fingerprints_cache = Chargement du cache des empreintes digitales
stage_saving_fingerprints_cache = Enregistrement du cache des empreintes digitales
stage_loading_exif_cache = Chargement de cache EXIF
...
stage_hiding_links = Cacher les liens durs { $items_stats }
stage_analyzed_partial_hash = Hash partiel analysé pour { $items_stats } fichiers ({ $size_stats })
stage_analyzed_full_hash = Hash complet analysé des { $items_stats } fichiers ({ $size_stats })
...
stage_hardlinking_files = Conversion en liens durs de { $items_stats } fichiers ({ $size_stats })
...
stage_optimizing_videos = Optimisation de la vidéo { $items_stats } ({ $size_stats })
