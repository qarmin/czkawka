...
core_failed_to_spawn_command = Échec de l'éjection de la commande : { $raison }
core_failed_to_check_process_status = Échec de la vérification de l’état du processus : { $raison }
core_failed_to_wait_for_process = Échec de l'attente du processus : { $raison }
core_failed_to_read_video_properties = Échec de la lecture des propriétés de la vidéo : { $raison }
core_failed_to_execute_ffmpeg = Échec de l'exécution de ffmpeg : { $raison }
...
core_optimized_file_larger = Fichier optimisé { $optimisé } (taille : { $new_size }) n'est pas plus petit que l'original { $original } (taille : { $original_size })
...
core_error_comparing_fingerprints = Erreur lors de la comparaison des empreintes digitales : { $raison }
