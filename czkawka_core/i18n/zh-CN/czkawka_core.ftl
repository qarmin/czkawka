...
core_hardlink_unsupported_filesystem = 文件系统位于 "{ $path }" 的位置不支持硬链接 ({ $reason })
...
core_properly_loaded_cache_entries = 成功加载了 { $count } 个缓存条目。.
...
stage_checked_tags = 已检查 { $items_stats } 个标签
stage_compared_tags = 已对比 { $items_stats } 个标签
stage_checked_content = 已检查 { $items_stats } 个内容（{ $size_stats }）
stage_compared_content = 已对比 { $items_stats } 个内容
...
stage_checking_empty_files_content = 正在检查 { $items_stats } 文件中的内容 ({ $size_stats })
...
stage_optimizing_videos = 正在优化 { $items_stats } 个视频（{ $size_stats }）
stage_optimizing_no_size_videos = 正在优化 { $items_stats } 个视频
