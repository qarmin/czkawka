...
core_hardlink_unsupported_filesystem = Το σύστημα αρχείων στο "{ $path }" δεν υποστηρίζει συμβολικούς συνδέσμους ({ $reason })
...
core_properly_loaded_cache_entries = Φορτώθηκαν επιτυχώς { $count } εγγραφές στην cache.
...
stage_collecting_folders = Εξέταση φακέλου { $entries_checked }
stage_scanning_name = Εξέταση του ονόματος του αρχείου { $entries_checked }
stage_scanning_size_name = Ελέγχος μεγέθους και ονόματος για { $entries_checked } αρχεία
...
stage_hiding_links = Κρύβοντας συνδέσμους { $items_stats }
stage_analyzed_partial_hash = Αναλύθηκε μερικό hash των αρχείων { $items_stats } ({ $size_stats })
stage_analyzed_full_hash = Αναλύθηκε το πλήρες hash των { $items_stats } αρχείων ({ $size_stats })
...
stage_compared_content = Συγκρίνετε τα περιεχόμενα των { $items_stats }
stage_hashed_images = Χασημένες { $items_stats } εικόνες ({ $size_stats })
stage_compared_image_hashes = Σύγκριση κατακερματισμών εικόνων για τα { $items_stats }
stage_hashed_videos = Κρυπτογραφημένα { $items_stats } βίντεο
...
stage_checked_files = Ελέγχθηκε το αρχείο { $items_stats } (μέγεθος: { $size_stats })
