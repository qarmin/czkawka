...
core_excluded_paths_pointless_slash = Excluir a barra '/' não faz sentido, pois significa que nenhum arquivo será verificado
...
core_needs_to_set_at_least_one_broken_option = Não foi possível iniciar a verificação porque nenhum tipo de arquivo corrompido foi definido para verificação
...
core_ffmpeg_not_found = Não foi possível encontrar a instalação dos programas 'FFmpeg' ou 'FFprobe'. Estes programas são externos e você tem que instalá-los manualmente.
core_ffmpeg_not_found_windows = Certifique-se de que o 'ffmpeg.exe' e o 'ffprobe.exe' estejam disponíveis no PATH ou sejam colocados diretamente na mesma pasta onde está o executável do programa
...
core_no_similarity_method_selected = Não foi possível encontrar os arquivos de música semelhantes porque um método de similaridade não foi definido
...
core_image_file_too_large = O arquivo de imagem é muito grande ({ $size } bytes) e excede o limite de { $limit } MB
...
core_properly_saved_cache_entries = { $count } entradas de cache foram salvas corretamente no arquivo.
core_properly_loaded_cache_entries = { $count } itens de cache foram carregados corretamente.
...
stage_collecting_files = Pesquisando { $entries_checked } arquivo(s)
stage_collecting_folders = Pesquisando { $entries_checked } pasta(s)
stage_scanning_name = Pesquisando por nome de { $entries_checked } arquivo(s)
stage_scanning_size_name = Pesquisando por nome e tamanho de { $entries_checked } arquivo(s)
stage_scanning_size = Pesquisando por tamanho de { $entries_checked } arquivo(s)
# Cache load/save (indeterminate, no counters)
stage_filtering_outdated_cache = Filtrando entradas de cache desatualizadas
stage_loading_prehash_cache = Carregando o ‘hash’ parcial do ‘cache’
stage_saving_prehash_cache = Salvando o ‘hash’ parcial no ‘cache’
stage_loading_hash_cache = Carregando o ‘hash’ do ‘cache’
stage_saving_hash_cache = Salvando o ‘hash’ no ‘cache’
stage_loading_tags_cache = Carregando as informações do ‘cache’
stage_saving_tags_cache = Salvando as informações no ‘cache’
stage_loading_fingerprints_cache = Carregando as impressões digitais do ‘cache’
stage_saving_fingerprints_cache = Salvando as impressões digitais no ‘cache’
stage_loading_exif_cache = Carregando o ‘EXIF’ do ‘cache’
stage_saving_exif_cache = Salvando o ‘EXIF’ no ‘cache’
...
stage_analyzed_partial_hash = Hash parcial analisado de { $items_stats } arquivos ({ $size_stats })
...
stage_compared_image_hashes = Hashes de imagem comparados de { $items_stats }
stage_hashed_videos = Hash calculado de { $items_stats } vídeos
stage_created_thumbnails = Foram criadas { $items_stats } miniaturas dos arquivos de vídeo
stage_checked_videos = Verificados { $items_stats } vídeos ({ $size_stats })
stage_extracted_exif_tags = Tags EXIF extraídas de { $items_stats } arquivos ({ $size_stats })
...
stage_deleting_files = Excluindo ‘{ $items_stats }’ arquivo(s) de ‘{ $size_stats }’
stage_deleting_no_size_files = Excluindo o arquivo ‘{ $items_stats }’
stage_renaming_files = Renomeando o arquivo ‘{ $items_stats }’
stage_moving_files = Movendo ‘{ $items_stats }’ arquivos de ‘{ $size_stats }’
stage_moving_no_size_files = Movendo o arquivo ‘{ $items_stats }’
stage_hardlinking_files = Criando ‘{ $items_stats }’ ligações rígidas de ‘{ $size_stats }’ arquivos
stage_hardlinking_no_size_files = Criando ‘{ $items_stats }’ ligações rígidas dos arquivos
stage_symlinking_files = Criando ‘{ $items_stats }’ ligações simbólicas de ‘{ $size_stats }’ arquivos
stage_symlinking_no_size_files = Criando ‘{ $items_stats }’ ligações simbólicas dos arquivos
stage_optimizing_videos = Foram otimizados ‘{ $items_stats }’ vídeos de ‘{ $size_stats }’ arquivos
stage_optimizing_no_size_videos = Foram otimizados ‘{ $items_stats }’ vídeos
stage_cleaning_exif = Removendo o ‘EXIF’ dos ‘{ $items_stats }’ arquivos de ‘{ $size_stats }’ arquivos
stage_cleaning_no_size_exif = Removendo o ‘EXIF’ do arquivo ‘{ $items_stats }’
