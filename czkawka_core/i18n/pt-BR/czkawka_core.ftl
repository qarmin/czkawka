...
stage_collecting_files = Pesquisando o arquivo ‘{ $entries_checked }’
stage_collecting_folders = Pesquisando a pasta ‘{ $entries_checked }’
stage_scanning_name = Pesquisando por nome do arquivo nos ‘{ $entries_checked }’
stage_scanning_size_name = Pesquisando por nome e por tamanho do arquivo nos ‘{ $entries_checked }’
stage_scanning_size = Pesquisando por tamanho do arquivo nos ‘{ $entries_checked }’
...
stage_analyzed_partial_hash = Analisando ‘{ $items_stats }’ código ‘hash’ parcial dos ‘{ $size_stats }’ arquivos
stage_analyzed_full_hash = Analisando ‘{ $items_stats }’ código ‘hash’ completo dos ‘{ $size_stats }’ arquivos
stage_checked_tags = Verificando as informações de ‘{ $items_stats }’
stage_compared_tags = Comparando as informações de ‘{ $items_stats }’
stage_checked_content = Verificando o conteúdo ‘{ $items_stats }’ de ‘{ $size_stats }’
stage_compared_content = Comparando o conteúdo de ‘{ $items_stats }’
stage_hashed_images = As informações de ‘{ $items_stats }’ arquivos ‘hash’ das imagens ‘{ $size_stats }’
stage_compared_image_hashes = Comparando ‘{ $items_stats }’ código ‘hash’ dos arquivos de imagem
stage_hashed_videos = Foram criados ‘{ $items_stats }’ do código ‘hash’ dos arquivos de vídeo
stage_created_thumbnails = Foram criados ‘{ $items_stats }’ miniaturas dos arquivos de vídeo
stage_checked_videos = Verificando ‘{ $items_stats }’ informações dos ‘{ $size_stats }’ arquivos de vídeo
stage_extracted_exif_tags = Os ‘EXIF’ foram extraídos de ‘{ $items_stats }’ arquivos de ‘{ $size_stats }’ arquivos
stage_checked_files = Verificando ‘{ $items_stats }’ informações dos ‘{ $size_stats }’ arquivos
stage_checked_files_bad_extensions = Verificando as informações do arquivo ‘{ $items_stats }’
stage_checked_files_bad_names = Verificando as informações do arquivo ‘{ $items_stats }’
