...
core_excluded_items_wildcard_required = Uitgesloten Items Waarschuwing: Wildcard * is vereist in expressie, stand { $expression }
...
core_properly_loaded_cache_entries = Goed geladen { $count } cache vermeldingen.
...
stage_scanning_size_name = Scannen grootte en naam van { $entries_checked } bestand
stage_scanning_size = Scannen van grootte { $entries_checked } bestand
...
stage_saving_prehash_cache = Opslaan van prehash cache
stage_loading_hash_cache = hash-cache laden
stage_saving_hash_cache = hash cache opslaan
stage_loading_tags_cache = Labels cache laden
...
stage_loading_exif_cache = Laad EXIF cache
stage_saving_exif_cache = Opslaan EXIF cache
...
stage_checked_tags = Labels van { $items_stats } gecontroleerd
...
stage_hashed_images = { $items_stats } afbeeldingen ({ $size_stats })
stage_compared_image_hashes = Vergeleken afbeeldingen van { $items_stats }
stage_hashed_videos = Gesashed { $items_stats } video's
...
stage_checked_files_bad_extensions = Gevalideerd { $items_stats } bestand
stage_checked_files_bad_names = Gevalideerd { $items_stats } bestand
...
stage_deleting_files = Verwijder { $items_stats } bestand ({ $size_stats })
stage_deleting_no_size_files = Verwijder { $items_stats } bestand
stage_renaming_files = { $items_stats } bestand hernoemen
stage_moving_files = { $items_stats } bestand ({ $size_stats })
