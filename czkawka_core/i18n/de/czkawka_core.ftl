...
core_excluded_items_wildcard_required = Ausgeschlossene Elemente Warnung: Wildcard * ist im Ausdruck erforderlich und ignoriert { $expression }
...
core_properly_loaded_cache_entries = Richtig geladen { $count } Cache-Einträge.
...
core_ffmpeg_error = FFmpeg Fehler bei der Verarbeitung { $file }, status code { $code }, reason { $reason }
...
stage_scanning_size_name = Scanne Größe und Name der { $entries_checked } Datei
stage_scanning_size = Scanne Größe der { $entries_checked } Dateien
# Cache load/save (indeterminate, no counters)
stage_filtering_outdated_cache = Filtern veralteter Cache-Einträge
stage_loading_prehash_cache = Lade Prehash-Cache
stage_saving_prehash_cache = Speichere Prehash-Cache
stage_loading_hash_cache = Hash-Cache wird geladen
stage_saving_hash_cache = Speichere Hash-Cache
stage_loading_tags_cache = Tag-Cache wird geladen
stage_saving_tags_cache = Speichere Tag-Cache
stage_loading_fingerprints_cache = Cache für Fingerabdrücke wird geladen
...
stage_analyzed_full_hash = Analysiert voller Hash von { $items_stats } Dateien ({ $size_stats })
stage_checked_tags = Markierte Tags von { $items_stats }
stage_compared_tags = Vergleiche Tags von { $items_stats }
...
stage_compared_image_hashes = Vergleiche Bildhashes von { $items_stats }
stage_hashed_videos = Hashed { $items_stats } Videos
stage_created_thumbnails = Thumbnails für { $items_stats } Videos erstellt
stage_checked_videos = Überprüft { $items_stats } Videos ({ $size_stats })
stage_extracted_exif_tags = Extrahierte EXIF-Tags aus { $items_stats } Dateien ({ $size_stats })
stage_checked_files = Überprüft { $items_stats } Datei ({ $size_stats })
stage_checked_files_bad_extensions = Überprüft { $items_stats } Datei
stage_checked_files_bad_names = Überprüft { $items_stats } Datei
...
stage_renaming_files = Umbenennen { $items_stats } Datei
stage_moving_files = Verschiebe { $items_stats } Datei ({ $size_stats })
stage_moving_no_size_files = Verschiebe { $items_stats } Datei
stage_hardlinking_files = Hardlinking { $items_stats } Datei ({ $size_stats })
stage_hardlinking_no_size_files = Hardlinking { $items_stats } Datei
stage_symlinking_files = Symlinking { $items_stats } Datei ({ $size_stats })
stage_symlinking_no_size_files = Symlinking { $items_stats } Datei
stage_optimizing_videos = Optimiert { $items_stats } Video ({ $size_stats })
stage_optimizing_no_size_videos = Optimiertes { $items_stats } Video
stage_cleaning_exif = Bereinigen EXIF aus { $items_stats } Datei ({ $size_stats })
stage_cleaning_no_size_exif = Bereinigen EXIF aus { $items_stats } Datei
