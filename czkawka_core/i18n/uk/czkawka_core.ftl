...
core_image_file_too_large = Розмір файлу зображення занадто великий ({ $size } байт) - перевищує ліміт у { $limit } МБ
...
stage_hashed_images = Згенеровано хешовані зображення { $items_stats } ({ $size_stats })
