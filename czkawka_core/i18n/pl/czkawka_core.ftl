...
core_directory_must_exists = Katalogi: Podana ścieżka folderu musi istnieć, ignorowanie { $path }
core_directory_must_be_directory = Katalogi: Podana ścieżka musi wskazywać na katalog, ignorowanie { $path }
core_included_directory_zero_valid_directories = Błąd katalogu: nie znaleziono nawet jednej poprawnej ścieżki, co jest wymagane
