...
core_directory_must_be_directory = الأدلة: المسار المقدم يجب أن يشير إلى دليل، تجاهل { $path }
core_included_directory_zero_valid_directories = خطأ في الدليل المضمن: حتى لم يتم العثور على مسار واحد صحيح مدرج، وهو مطلوب
...
core_ffmpeg_not_found = لا يمكن العثور على تثبيت مناسب من FFmpeg. هذا برنامج خارجي تحتاج إلى تثبيته يدوياً.
...
rust_error_moving_to_trash = حدث خطأ أثناء نقل "{ $file }" إلى سلة المهملات: { $error }
rust_error_removing = حدث خطأ أثناء إزالة "{ $file }": { $error }
