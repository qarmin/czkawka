...
core_path_must_exists = Angitt sti må eksistere, ignorere { $sti }
...
core_optimized_file_larger = Optimalisert fil { $optimalisert } (størrelse: { $ny_størrelse }) er ikke mindre enn original { $original } (størrelse: { $original_størrelse })
...
core_folder_does_not_exist = Mappe finnes ikke: { $mappe }
...
core_invalid_extension_contains_dot = { $utvidelse } er ikke en gyldig utvidelse fordi den inneholder punktum inne
