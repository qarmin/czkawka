...
option_audio_preset_clip = Clip plus long
...
dir_open_folder = Ouvrir le répertoire
# Compare view
compare_label = Comparer
compare_loading = Chargement des images…
compare_cancelling = Annulation en cours…
compare_computing = Calcul des différences…
