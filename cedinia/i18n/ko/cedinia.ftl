...
settings_temporary_files_extensions_label = 확장 기능
...
settings_dark_theme_desc = 어두운 색상 테마를 사용하세요
...
rename_error_read_directory = 디렉터리 읽기 실패
and_more_prefix = ...그리고
and_more_suffix = 더
...
similar_videos_group_header = { $count } 개의 유사한 동영상
# Rename confirmation
...
option_audio_preset_identical = 동일한
option_audio_preset_clip = 더 길게 잘라주세요
option_audio_preset_similar = 유사한
...
compare_mode_normal = 측면
compare_mode_split = 분리
compare_mode_overlay = 오버레이
compare_mode_diff = 차이점
compare_res_mismatch = 다양한 해상도 - 차이가 정확하지 않을 수 있습니다
