...
settings_temporary_files_header = TEMPORARIS BESTANDEN
...
settings_similar_videos_header = VERGELIJKENDE VIDEO'S (AUDIO)
settings_similar_videos_audio_preset = Voorinstelling audiogelijkaardigheid
...
similar_videos_group_header = { $count } soortgelijke video's
# Rename confirmation
...
option_audio_preset_clip = Clip langer
...
compare_loading = Afbeeldingen aan het laden…
