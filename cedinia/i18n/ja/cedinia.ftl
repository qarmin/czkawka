...
settings_temporary_files_header = テンポラリーファイル
settings_temporary_files_extensions_label = 拡張
...
similar_videos_group_header = { $count } 同様の動画
# Rename confirmation
...
option_audio_preset_clip = クリップを長くする
option_audio_preset_similar = 似ています
...
# Compare view
compare_label = 比較
compare_loading = 画像を読み込んでいます…
compare_cancelling = キャンセル中…
compare_computing = 差分を計算中…
