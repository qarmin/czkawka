...
TAB_DISPLAY_KEYS = {
    ActiveTab.DUPLICATE_FILES: "tool-duplicate-files",
    ActiveTab.EMPTY_FOLDERS: "tool-empty-folders",
    ActiveTab.BIG_FILES: "tool-big-files",
    ActiveTab.EMPTY_FILES: "tool-empty-files",
    ActiveTab.TEMPORARY_FILES: "tool-temporary-files",
    ActiveTab.SIMILAR_IMAGES: "tool-similar-images",
    ActiveTab.SIMILAR_VIDEOS: "tool-similar-videos",
    ActiveTab.SIMILAR_MUSIC: "tool-similar-music",
    ActiveTab.INVALID_SYMLINKS: "tool-invalid-symlinks",
    ActiveTab.BROKEN_FILES: "tool-broken-files",
    ActiveTab.BAD_EXTENSIONS: "tool-bad-extensions",
...
class ToolSettings:
    ...
    dup_name_similarity_threshold: float = 0.85
