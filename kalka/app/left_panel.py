...
from .models import ActiveTab, TAB_DISPLAY_KEYS, TABS_WITH_SETTINGS
...
class LeftPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        if logo_path:
            ...
            title_label = QLabel(tr("fallback-app-name"))
            title_font = QFont()
        ...
        self._settings_btn.setToolTip(tr("settings-tooltip"))
        ...
        self._tool_settings_btn.setToolTip(tr("tool-settings-tooltip"))
        ...
        for tab in self.TOOL_TABS:
            item = QListWidgetItem(tr(TAB_DISPLAY_KEYS[tab]))
        ...
        # Version label
        version_label = QLabel(tr("version-label"))
