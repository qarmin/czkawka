...
popover_select_one_oldest_same_size = Select one oldest (same size)
popover_select_one_newest_same_size = Select one newest (same size)
popover_mark_same_size = Mark groups with same size
popover_select_one_oldest_same_path = Select one oldest (same path)
popover_select_one_newest_same_path = Select one newest (same path)
popover_select_one_oldest_longest_path = Select one oldest (longest path)
popover_select_one_newest_longest_path = Select one newest (longest path)
popover_select_one_oldest_shortest_path = Select one oldest (shortest path)
popover_select_one_newest_shortest_path = Select one newest (shortest path)
...
select_dialog_title = Selection
select_dialog_action = Action
select_dialog_action_all_except = Select all except...
select_dialog_action_one = Select one...
select_dialog_action_select_all = Select All
select_dialog_action_unselect_all = Unselect All
select_dialog_action_reverse = Reverse Selection
select_dialog_action_mark_same_size = Mark groups with same size
select_dialog_action_custom_select = Custom select
select_dialog_action_custom_unselect = Custom unselect
select_dialog_criterion = Criterion
select_dialog_criterion_date = Date
select_dialog_criterion_path = Path length
select_dialog_criterion_size = Size
select_dialog_direction = Direction
select_dialog_direction_oldest = Oldest
select_dialog_direction_newest = Newest
select_dialog_direction_shortest = Shortest
select_dialog_direction_longest = Longest
select_dialog_direction_smallest = Smallest
select_dialog_direction_biggest = Biggest
select_dialog_path_filter = Path filter
select_dialog_path_filter_any = Any
select_dialog_path_filter_longest = Longest only
select_dialog_path_filter_shortest = Shortest only
select_dialog_conditions = Conditions
select_dialog_cond_none = None
select_dialog_cond_same_size = Same size only
select_dialog_cond_same_path = Same path only
select_dialog_custom = Custom filter
