...
# Krokiet info dialog
krokiet_info_title = Avviso di Deprecazione
krokiet_info_message =
    Czkawka GTK 12.0 è il rilascio finale. Non sono previsti ulteriori aggiornamenti, funzionalità o correzioni di bug.
    
    La maggior parte delle caratteristiche di Czkawka GTK sono disponibili in Krokiet, di solito in una forma più semplice, veloce e più stabile. Krokiet aggiunge anche nuove funzionalità e miglioramenti che non erano possibili nella versione GTK.
    
    Se stai ancora usando Czkawka GTK, passare a Krokiet dovrebbe essere facile, poiché ha un'interfaccia simile, meno dipendenze e un migliore supporto multipiattaforma.
...
music_compare_only_in_title_group_tooltip =
    ...
    Con 10000 file, invece di 100 milioni di confronti di solito ci saranno circa 20000 confronti.
same_music_tooltip =
...
duplicate_check_method_tooltip =
    ...
    Hash - Trova i file che hanno lo stesso contenuto. Questa modalità fa la hash sui file e in seguito la confronta per trovare i duplicati. Questa modalità è il modo più sicuro per trovare i duplicati. Czkawka usa pesantemente la cache quindi successive scansioni degli stessi file dovrebbero essere molto più veloci del primo.
...
image_geometric_invariance_tooltip = Confronta anche le varianti a specchio/capovolto e ruotate opzionalmente di ogni immagine. Questo migliora la corrispondenza ma aumenta il tempo di hashing.
...
main_notebook_symlinks = Collegamenti simbolici invalidi
main_notebook_broken_files = File danneggiati
...
main_tree_view_column_similarity = Somiglianza
...
main_tree_view_column_symlink_file_name = Nome Collegamento Simbolico
...
main_label_geometric_invariance = Invarianza geometrica
...
main_label_similarity = Somiglianza{ "   " }
main_check_box_broken_files_audio = Audio
main_check_box_broken_files_pdf = Pdf
main_check_box_broken_files_archive = Archivio
main_check_box_broken_files_image = Immagine
main_check_box_broken_files_video = Video
main_check_box_broken_files_video_tooltip = Usa ffmpeg/ffprobe per convalidare i file video. Piuttosto lento, potrebbe rilevare errori pedanti anche se il file viene riprodotto correttamente.
...
upper_recursive_button_tooltip = Se selezionato, cerca anche tra i file che non si trovano direttamente nelle cartelle scelte.
...
upper_remove_included_button_tooltip = Elimina cartella dalla ricerca.
...
upper_add_excluded_button_tooltip = Aggiungi una cartella da escludere dalla ricerca.
upper_remove_excluded_button_tooltip = Rimuovi una cartella da quelle escluse.
...
upper_allowed_extensions_tooltip =
    ...
    Sono disponibili anche le seguenti Macro, che aggiungono più estensioni contemporaneamente: IMAGE, VIDEO, MUSIC, TEXT.
    
    Esempio di utilizzo ".exe, IMAGE, VIDEO, .rar, 7z" - questo significa che verranno analizzati le immagini (ad esempio jpg, png), i video (ad esempio avi, mp4), exe, rar e i file 7z.
...
popover_select_all_except_shortest_path = Seleziona tutto tranne il percorso più breve
popover_select_all_except_longest_path = Seleziona tutto tranne il percorso più lungo
popover_select_all_except_oldest = Seleziona tutto tranne il più vecchio
popover_select_all_except_newest = Seleziona tutto tranne il più recente
...
popover_unselect_custom = Deselezione personalizzata
popover_select_all_images_except_biggest = Seleziona tutto tranne il più grande
popover_select_all_images_except_smallest = Seleziona tutto tranne il più piccolo
...
bottom_select_button_tooltip = Seleziona i risultati. Solo i file/cartelle selezionati possono essere elaborati in seguito.
bottom_delete_button_tooltip = Elimina i file/cartelle selezionati.
...
bottom_show_errors_tooltip = Mostra/Nascondi il pannello di testo inferiore.
bottom_show_upper_notebook_tooltip = Mostra/Nasconde il pannello comandi.
# Progress Window
progress_stop_button = Interrompi
progress_stop_additional_message = Interruzione richiesta
# About Window
...
about_other_apps_button = Altre Applicazioni
about_other_apps_dialog_title = Altre applicazioni di qarmin
about_other_apps_open_source_note = Tutte le applicazioni elencate sono gratuite e open source.
about_other_apps_open_button = Apri
about_other_apps_szyszka_desc = Rinominatore di file veloce e potente.
about_other_apps_mykrut_desc = Semplice file manager Linux, veloce e con scelte di design precise.
about_other_apps_dcmki_viewer_desc = Semplice visualizzatore DICOM.
about_other_apps_video_thumbnailer_desc = Wrapper intorno al generatore di miniature video utilizzato in Czkawka.
about_other_apps_space_finder_desc = Cercatore semplice dei file più grandi sul vostro sistema.
about_other_apps_system_info_collector_desc = Raccoglie l'utilizzo di RAM/CPU dal sistema operativo e lo mostra come grafici.
# Header
...
header_krokiet_button_tooltip = Prova Krokiet - la versione nuova e migliorata!
# Krokiet promo dialog
krokiet_promo_title = Incontra Krokiet!
krokiet_promo_message =
    Ciao, coraggioso utente Czkawka!
    
    La forza è chiaramente con te, ma Krokiet no: un pulitore di duplicati più nuovo, più veloce, più leggero e significativamente più bello (ammesso che le applicazioni possano davvero essere belle).
    
    Krokiet include tutto ciò che la gente amava su Czkawka. È completamente gratuito, open source, ha un'interfaccia utente unica e semplice (sia elogiata che odiata da molti), introduce un sacco di nuove funzionalità, utilizza meno dipendenze, e funziona molto più in modo affidabile su diverse piattaforme.
    
    E se in qualche modo ti sei perso, c'è già un'app ancora più recente di Krokiet - Cedinia, progettata principalmente per i dispositivi Android e l'utilizzo touchscreen.
    
    Czkawka GTK ci ha servito bene, ma il suo turno di guardia è finito.
krokiet_promo_link_download = Scarica Krokiet/Cedinia
krokiet_promo_link_project = Pagina del progetto
...
settings_confirm_link_button_tooltip = Mostra la finestra di conferma quando si fa clic sul pulsante di collegamento fisico/simbolico.
...
settings_use_cache_button_tooltip = Usa la cache dei file.
settings_save_also_as_json_button_tooltip = Salva la cache in formato JSON (leggibile). È possibile modificarne il contenuto. La cache da questo file verrà letta automaticamente dall'app se manca la cache in formato binario (con estensione bin).
...
settings_confirm_deletion_button = Mostra finestra di conferma all'eliminazione di qualsiasi file
settings_confirm_link_button = Mostra finestra di conferma alla creazione di collegamenti per qualsiasi file
settings_confirm_group_deletion_button = Mostra finestra di conferma all'eliminazione di tutti gli elementi in un gruppo
...
settings_multiple_delete_outdated_cache_checkbutton = Elimina automaticamente le voci obsolete della cache
settings_multiple_delete_outdated_cache_checkbutton_tooltip =
    Elimina i risultati della cache obsoleti che puntano a file inesistenti.
    
    Quando abilitata, l'app si assicura, durante il caricamento dei risultati, che tutti puntino a file validi (quelli non validi vengono ignorati).
    ...
    Nel caso di avere centinaia di migliaia di risultati nella cache, si consiglia di abilitare questa funzione, che velocizzerà il caricamento della cache/salvataggio all'inizio/fine della scansione.
...
settings_multiple_clear_cache_button_tooltip =
    ...
    Questo dovrebbe essere usato solo se la pulizia automatica è stata disabilitata.
settings_multiple_clear_cache_button = Rimuovi i risultati obsoleti dalla cache.

## Duplicates

settings_duplicates_hide_hard_link_button_tooltip =
    Nasconde tutti i file tranne uno, se tutti puntano agli stessi dati (sono collegamenti fisici).
    
    Esempio: nel caso in cui ci siano (su disco) sette file collegati fisicamente a dati specifici e un file diverso con gli stessi dati ma un inode diverso, nel cercatore di duplicati verrà mostrato solo un file univoco e un file tra quelli collegati fisicamente.
...
settings_duplicates_hide_hard_link_button = Nascondi collegamenti fisici
settings_duplicates_prehash_checkbutton = Utilizza la cache prehash
...
compute_found_empty_folders = Trovate { $number_files } cartelle vuote in { $time }
...
compute_found_images = Trovate { $number_files } immagini simili in { $number_groups } gruppi in { $time }
compute_found_videos = Trovati { $number_files } video simili in { $number_groups } gruppi in { $time }
compute_found_music = Trovati { $number_files } file musicali simili in { $number_groups } gruppi in { $time }
compute_found_invalid_symlinks = Trovati { $number_files } collegamenti simbolici invalidi in { $time }
compute_found_broken_files = Trovati { $number_files } file danneggiati in { $time }
...
# Saving loading 
saving_loading_saving_success = Configurazione salvata correttamente nel file { $name }.
...
saving_loading_no_config_file = Nessun file di configurazione trovato, usando le impostazioni predefinite.
...
text_view_warnings = AVVISI
text_view_errors = ERRORI
about_window_motto = Questo programma può essere usato liberamente e lo sarà sempre.
krokiet_new_app = Questa versione GTK di Czkawka non è più sviluppata a partire dalla versione 12. Per nuove funzionalità e sviluppo attivo, utilizza Krokiet, che è più stabile e performante.
# Various dialog
...
delete_title_dialog = Conferma di eliminazione
delete_question_label = Sei sicuro di eliminare i file?
delete_all_files_in_group_title = Conferma di eliminazione di tutti i file nel gruppo
delete_all_files_in_group_label1 = In alcuni gruppi tutti i record sono selezionati.
delete_all_files_in_group_label2 = Sei sicuro di eliminarli tutti?
delete_items_label = { $items } file verranno eliminati.
delete_items_groups_label = { $items } file da { $groups } gruppi verranno eliminati.
hardlink_failed = Collegamento fisico di { $name } a { $target } non riuscito, motivo { $reason }
...
move_folder_failed = Spostamento cartella { $name } fallito, motivo { $reason }
move_file_failed = Spostamento file { $name } fallito, motivo { $reason }
...
search_not_choosing_any_broken_files = ERRORE: è necessario selezionare almeno una casella di controllo relativa al tipo di file danneggiati da verificare.
...
cache_clear_message_label_3 = Questo può velocizzare leggermente il caricamento/salvataggio della cache.
