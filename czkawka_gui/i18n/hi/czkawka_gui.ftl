...
window_main_title = Czkawka (हिचकी)
window_progress_title = स्कैनिंग
window_compare_images = छवियों की तुलना
# General
general_ok_button = ठीक है
general_close_button = बंद करें
# Krokiet info dialog
krokiet_info_title = अप्रचलन सूचना
krokiet_info_message = 
    Czkawka GTK 12.0 अंतिम संस्करण है। आगे कोई अपडेट, नई सुविधाएँ या बग फिक्स जारी नहीं किए जाएंगे।
    
    Czkawka GTK की अधिकांश सुविधाएँ Krokiet में उपलब्ध हैं, आमतौर पर एक सरल, तेज़ और अधिक स्थिर रूप में। Krokiet में नई सुविधाएँ और सुधार भी शामिल हैं जो GTK संस्करण में संभव नहीं थे।
    
    यदि आप अभी भी Czkawka GTK का उपयोग कर रहे हैं, तो Krokiet में स्विच करना आसान होना चाहिए, क्योंकि इसमें समान इंटरफ़ेस है, कम निर्भरताएँ हैं, और बेहतर क्रॉस-प्लेटफ़ॉर्म समर्थन है।
    
    PS: यह संदेश केवल एक बार दिखाई देना चाहिए। यदि यह फिर से दिखाई देता है, तो CZKAWKA_DONT_ANNOY_ME नामक पर्यावरण चर को किसी भी गैर-रिक्त मान पर सेट करें।.
# Main window
...
same_music_seconds_label = न्यूनतम खंड अवधि (सेकंड में)
...
duplicate_case_sensitive_name = केस सेंसिटिव
...
duplicate_mode_hash_combo_box = हैश
...
image_resize_filter_tooltip = 
    छवि का हैश निकालने के लिए, लाइब्रेरी को पहले उसे रीसाइज करना होगा।
    
    चुने गए एल्गोरिदम के आधार पर, हैश की गणना के लिए उपयोग की जाने वाली छवि थोड़ी अलग दिख सकती है।
...
image_geometric_invariance_tooltip = प्रत्येक छवि के उलटे/पलटे और वैकल्पिक रूप से घुमाए गए संस्करणों की भी तुलना करें। इससे मिलान बेहतर होता है, लेकिन हैशिंग में लगने वाला समय बढ़ जाता है।.
...
main_tree_view_column_symlink_file_name = सिमलिंक फ़ाइल का नाम
main_tree_view_column_symlink_folder = सिमलिंक फ़ोल्डर
...
main_tree_view_column_fps = एफपीएस
...
main_label_geometric_invariance = ज्यामितीय अपरिवर्तनशीलता
main_label_size_bytes = आकार (बाइट में)
main_label_min_size = न्यूनतम
main_label_max_size = अधिकतम
main_label_shown_files = दिखाई गई फ़ाइलों की संख्या
main_label_resize_algorithm = आकार बदलने का एल्गोरिदम
main_label_similarity = समानता{ "   " }
main_check_box_broken_files_audio = ऑडियो
main_check_box_broken_files_pdf = पीडीएफ
...
upper_manual_add_included_button_tooltip =
    ...
    एक साथ कई पथ जोड़ने के लिए, उन्हें ";" से अलग करें।
    
    "/home/roman;/home/rozkaz" दो डायरेक्टरी /home/roman और /home/rozkaz को जोड़ देगा।
upper_add_included_button_tooltip = खोज में एक नई डायरेक्टरी जोड़ें।.
upper_remove_included_button_tooltip = खोज से डायरेक्टरी हटाएं।.
upper_manual_add_excluded_button_tooltip =
    हाथ से बहिष्कृत डायरेक्टरी का नाम जोड़ें।
    
    एक साथ कई पथ जोड़ने के लिए, उन्हें ";" से अलग करें।
    
    "/home/roman;/home/krokiet" दो डायरेक्टरी "/home/roman" और "/home/krokiet" जोड़ देगा।
upper_add_excluded_button_tooltip = खोज में शामिल न की जाने वाली डायरेक्टरी को जोड़ें।.
upper_remove_excluded_button_tooltip = डायरेक्टरी को "बहिष्कृत" सूची से हटाएँ।.
...
upper_excluded_items_tooltip = 
    ...
    यह "बहिष्कृत पथ" की तुलना में धीमा है, इसलिए इसका सावधानीपूर्वक उपयोग करें।.
...
popover_select_all_except_shortest_path = सभी का चयन करें, सिवाय सबसे छोटे पथ के
...
popover_unselect_custom = कस्टम विकल्प का चयन रद्द करें
popover_select_all_images_except_biggest = सभी को चुनें, लेकिन सबसे बड़े को छोड़कर
popover_select_all_images_except_smallest = सभी का चयन करें, लेकिन सबसे छोटे को छोड़कर
popover_custom_path_check_button_entry_tooltip =
    पथ के आधार पर रिकॉर्ड चुनें।
...
popover_custom_regex_check_button_entry_tooltip =
    ...
    इस मोड में, खोजा गया टेक्स्ट "Path with Name" होता है।
...
popover_custom_not_all_check_button_tooltip = 
    ...
    यह डिफ़ॉल्ट रूप से सक्षम होता है, क्योंकि अधिकांश स्थितियों में, आप मूल और डुप्लिकेट दोनों फ़ाइलों को हटाना नहीं चाहते हैं, बल्कि कम से कम एक फ़ाइल को रखना चाहते हैं।
    
    चेतावनी: यह सेटिंग काम नहीं करेगी यदि आपने पहले से ही किसी समूह में सभी परिणामों को मैन्युअल रूप से चुना है।.
popover_custom_regex_path_label = पथ
popover_custom_regex_name_label = नाम
popover_custom_regex_regex_label = रेगेक्स पथ + नाम
...
popover_custom_mode_unselect = कस्टम विकल्प का चयन रद्द करें
...
bottom_symlink_button = सिमलिंक
bottom_hardlink_button = हार्डलिंक
bottom_move_button = स्थानांतरित करें
...
bottom_symlink_button_tooltip = 
    ...
    पहला परिणाम अपरिवर्तित रहता है, और दूसरा और उसके बाद के सभी परिणाम पहले परिणाम से सिमलिंक किए जाते हैं।.
bottom_hardlink_button_tooltip = 
    हार्डलिंक बनाएँ।
    यह केवल तभी काम करता है जब किसी समूह में कम से कम दो परिणाम चुने गए हों।
    पहला परिणाम अपरिवर्तित रहता है, और दूसरा और बाद के परिणाम पहले परिणाम से हार्डलिंक किए जाते हैं।.
...
bottom_compare_button_tooltip = समूह में मौजूद छवियों की तुलना करें।.
...
progress_stop_additional_message = रोकने का अनुरोध किया गया
# About Window
...
about_other_apps_button = अन्य ऐप्स
about_other_apps_dialog_title = qarmin द्वारा अन्य एप्लिकेशन
about_other_apps_open_source_note = सभी सूचीबद्ध एप्लिकेशन मुफ्त और ओपन सोर्स हैं।.
about_other_apps_open_button = खोलें
about_other_apps_szyszka_desc = तेज़ और शक्तिशाली फ़ाइल रीनेमर।.
about_other_apps_mykrut_desc = एक सरल, तेज़ और विशिष्ट विशेषताओं वाला लिनक्स फ़ाइल मैनेजर।.
about_other_apps_dcmki_viewer_desc = एक सरल DICOM दर्शक।.
about_other_apps_video_thumbnailer_desc = Czkawka में उपयोग किए जाने वाले वीडियो थंबनेल जनरेटर के चारों ओर एक रैपर।.
about_other_apps_space_finder_desc = अपने सिस्टम पर सबसे बड़ी फ़ाइलों को आसानी से ढूंढने वाला टूल।.
about_other_apps_system_info_collector_desc = यह उपकरण ऑपरेटिंग सिस्टम से रैम/सीपीयू के उपयोग की जानकारी एकत्र करता है और उसे ग्राफ के रूप में प्रदर्शित करता है।.
# Header
header_setting_button_tooltip = सेटिंग्स डायलॉग बॉक्स खोलता है।.
header_about_button_tooltip = ऐप के बारे में जानकारी वाला एक डायलॉग बॉक्स खुलता है।.
header_krokiet_button_tooltip = एक बार Krokiet को जरूर आजमाएं - यह नया और बेहतर संस्करण है!
# Krokiet promo dialog
krokiet_promo_title = मिलिए Krokiet से!
krokiet_promo_message = 
    नमस्ते, साहसी Czkawka उपयोगकर्ता!
    
    यह स्पष्ट है कि 'द फोर्स' (The Force) आपके साथ है, लेकिन Krokiet नहीं है - यह एक नया, तेज़, हल्का और काफी हद तक अधिक आकर्षक (मान लीजिए कि ऐप्स वास्तव में आकर्षक हो सकते हैं) डुप्लिकेट क्लीनर है।
    
    Krokiet में वह सब कुछ शामिल है जो लोगों को Czkawka में पसंद था। यह पूरी तरह से मुफ्त है, ओपन सोर्स है, इसमें एक अनूठा और सरल यूआई (UI) है (जिसे कई लोगों ने सराहा भी है और नापसंद भी), यह कई नई सुविधाएँ प्रदान करता है, इसमें कम निर्भरताएँ हैं, और यह विभिन्न प्लेटफार्मों पर बहुत अधिक विश्वसनीय रूप से काम करता है।
    
    और यदि आपने इसे किसी तरह मिस कर दिया, तो Krokiet से भी नया एक ऐप है - Cedinia, जिसे मुख्य रूप से Android उपकरणों और टचस्क्रीन उपयोग के लिए डिज़ाइन किया गया है।
    
    Czkawka GTK ने हमारी अच्छी सेवा की, लेकिन अब उसका समय समाप्त हो गया है।.
krokiet_promo_link_download = Krokiet/Cedinia डाउनलोड करें
krokiet_promo_link_project = परियोजना पृष्ठ
...
settings_number_of_threads_tooltip = उपयोग किए गए थ्रेड्स की संख्या, 0 का अर्थ है कि सभी उपलब्ध थ्रेड्स का उपयोग किया जाएगा।.
settings_use_rust_preview = पूर्वावलोकन लोड करने के लिए GTK के बजाय बाहरी लाइब्रेरी का उपयोग करें
...
settings_save_at_exit_button_tooltip = ऐप बंद करते समय, कॉन्फ़िगरेशन को फ़ाइल में सहेजें।.
settings_load_at_start_button_tooltip = 
    ऐप खोलते समय, फ़ाइल से कॉन्फ़िगरेशन लोड करें।
    
    यदि यह सक्षम नहीं है, तो डिफ़ॉल्ट सेटिंग्स का उपयोग किया जाएगा।.
settings_confirm_deletion_button_tooltip = जब 'हटाएं' बटन पर क्लिक किया जाए, तो एक पुष्टिकरण संवाद प्रदर्शित करें।.
settings_confirm_link_button_tooltip = जब आप हार्ड लिंक/सिमलिंक बटन पर क्लिक करते हैं, तो एक पुष्टिकरण संवाद दिखाएं।.
...
settings_confirm_deletion_button = किसी भी फ़ाइल को हटाते समय, पुष्टि संवाद दिखाएं
settings_confirm_link_button = जब भी कोई फ़ाइल हार्ड लिंक या सिमलिंक की जाती है, तो एक पुष्टि संवाद दिखाएं
settings_confirm_group_deletion_button = जब आप किसी समूह में मौजूद सभी फ़ाइलें हटाते हैं, तो एक पुष्टि संवाद दिखाएं
...
settings_use_trash_button = हटाई गई फ़ाइलों को ट्रैश में ले जाएं
settings_language_label = भाषा
settings_multiple_delete_outdated_cache_checkbutton = स्वचालित रूप से पुरानी कैश प्रविष्टियों को हटाएं
settings_multiple_delete_outdated_cache_checkbutton_tooltip = 
    ...
    यदि आपके पास कैश में लाखों रिकॉर्ड हैं, तो इस सुविधा को सक्षम करने की अनुशंसा की जाती है, जिससे स्कैन की शुरुआत/अंत में कैश को लोड करने/सहेजने की गति बढ़ जाएगी।.
...
settings_multiple_clear_cache_button_tooltip = 
    पुराने प्रविष्टियों की कैश को मैन्युअल रूप से साफ़ करें।
...
settings_duplicates_minimal_size_entry_tooltip = 
    ...
    एक छोटा मान चुनने से अधिक रिकॉर्ड उत्पन्न होंगे। इससे खोज तेज हो जाएगी, लेकिन कैश लोड करने/सहेजने की प्रक्रिया धीमी हो जाएगी।.
...
settings_duplicates_prehash_minimal_entry_tooltip = कैश की गई प्रविष्टि का न्यूनतम आकार।.
...
settings_duplicates_minimal_size_cache_prehash_label = प्री-हैश कैश में सहेजी जाने वाली फ़ाइलों का न्यूनतम आकार (बाइट्स में)
...
settings_folder_cache_open_tooltip = 
    फ़ोल्डर खोलता है जहाँ कैश txt फ़ाइलें संग्रहीत हैं।
    
    कैश फ़ाइलों को बदलने से गलत परिणाम दिखाई दे सकते हैं। हालाँकि, पथ को बदलने से समय की बचत हो सकती है जब बड़ी संख्या में फ़ाइलों को किसी अन्य स्थान पर ले जाया जा रहा हो।
    
    आप इन फ़ाइलों को कंप्यूटरों के बीच कॉपी कर सकते हैं ताकि फ़ाइलों को फिर से स्कैन करने में लगने वाला समय बचाया जा सके (बेशक, अगर उनकी डायरेक्टरी संरचना समान है)।
    
    यदि कैश में कोई समस्या है, तो इन फ़ाइलों को हटाया जा सकता है। ऐप स्वचालित रूप से उन्हें फिर से उत्पन्न कर देगा।.
...
compute_found_empty_files = मिलीं { $number_files } खाली फ़ाइलें, समय: { $time }
compute_found_big_files = मिलीं { $number_files } बड़ी फ़ाइलें, समय: { $time }
compute_found_temporary_files = यहाँ { $number_files } अस्थायी फ़ाइलें { $time } में मिलीं।
compute_found_images = { $time } में, { $number_groups } समूहों में { $number_files } समान छवियाँ पाई गईं।
...
compute_found_invalid_symlinks = मिले { $number_files } अमान्य सिमलिंक, समय: { $time }
compute_found_broken_files = मिलीं { $number_files } टूटी हुई फ़ाइलें, समय: { $time }
...
# Progress window
progress_current_stage = वर्तमान चरण:{ "  " }
progress_all_stages = सभी चरण:{ "  " }
# Saving loading 
...
saving_loading_no_config_file = कोई कॉन्फ़िगरेशन फ़ाइल नहीं मिली, इसलिए डिफ़ॉल्ट सेटिंग्स का उपयोग किया जा रहा है।.
...
searching_for_data = डेटा खोजा जा रहा है, इसमें थोड़ा समय लग सकता है, कृपया प्रतीक्षा करें...
text_view_messages = संदेश
text_view_warnings = चेतावनियाँ
text_view_errors = त्रुटियाँ
about_window_motto = यह प्रोग्राम उपयोग करने के लिए मुफ्त है और हमेशा रहेगा।.
krokiet_new_app = Czkawka का यह GTK संस्करण अब संस्करण 12 से आगे विकसित नहीं किया जा रहा है। नई सुविधाओं और सक्रिय विकास के लिए, कृपया Krokiet का उपयोग करें, जो अधिक स्थिर और बेहतर प्रदर्शन वाला है।.
# Various dialog
dialogs_ask_next_time = अगली बार पूछना
symlink_failed = { $name } को { $target } से सिमलिंक करने में विफल, कारण: { $reason }
delete_title_dialog = हटाने की पुष्टि
delete_question_label = क्या आप वाकई में फ़ाइलों को हटाना चाहते हैं?
...
delete_items_label = { $items } फ़ाइलें हटाई जाएंगी।.
...
hard_sym_invalid_selection_title_dialog = कुछ समूहों में अमान्य चयन
hard_sym_invalid_selection_label_1 = कुछ समूहों में केवल एक रिकॉर्ड ही चुना जाता है, और उसे अनदेखा कर दिया जाएगा।.
hard_sym_invalid_selection_label_2 = इन फ़ाइलों को हार्ड/सिमलिंक करने के लिए, समूह में कम से कम दो परिणाम चुने जाने चाहिए।.
...
move_folder_failed = फ़ोल्डर { $name } को स्थानांतरित करने में विफल, कारण: { $reason }
move_file_failed = फ़ाइल { $name } को स्थानांतरित करने में विफल, कारण: { $reason }
move_files_title_dialog = उस फ़ोल्डर का चयन करें जिसमें आप डुप्लिकेट फ़ाइलों को स्थानांतरित करना चाहते हैं
move_files_choose_more_than_1_path = उनकी डुप्लिकेट फ़ाइलों की प्रतिलिपि बनाने में सक्षम होने के लिए केवल एक पथ चुना जा सकता है, { $path_number } चयनित।.
move_stats = { $num_files }/{ $all_files } आइटम सही ढंग से स्थानांतरित किए गए
save_results_to_file = परिणामों को txt और json दोनों फ़ाइलों के रूप में "{ $name }" फ़ोल्डर में सहेजा गया।.
search_not_choosing_any_music = त्रुटि: आपको संगीत खोज के कम से कम एक प्रकार के लिए बॉक्स का चयन करना होगा।.
search_not_choosing_any_broken_files = त्रुटि: आपको कम से कम एक ऐसा चेकबॉक्स चुनना होगा जिसमें टूटी हुई फ़ाइलों के प्रकार निर्दिष्ट हों।.
include_folders_dialog_title = शामिल करने के लिए फ़ोल्डर
exclude_folders_dialog_title = बहिष्कृत करने के लिए फ़ोल्डर
include_manually_directories_dialog_title = डायरेक्टरी को मैन्युअल रूप से जोड़ें
cache_properly_cleared = सही तरीके से कैश साफ़ किया गया
cache_clear_duplicates_title = डुप्लिकेट कैश साफ़ करना
cache_clear_similar_images_title = समान छवियों की कैश साफ़ करना
cache_clear_similar_videos_title = समान वीडियो की कैश साफ़ करना
...
cache_clear_message_label_3 = यह शायद कैश में डेटा लोड करने/सहेजने की प्रक्रिया को थोड़ा तेज कर सकता है।.
...
# Show preview
preview_image_resize_failure = छवि { $name } का आकार बदलने में विफल।.
preview_image_opening_failure = छवि { $name } खोलने में विफल, कारण: { $reason }
# Compare images (L is short Left, R is short Right - they can't take too much space)
compare_groups_number = समूह { $current_group }/{ $all_groups } ({ $images_in_group } छवियाँ)
compare_move_left_button = बा
compare_move_right_button = दा
