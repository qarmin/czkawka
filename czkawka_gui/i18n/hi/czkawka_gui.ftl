...
# Krokiet info dialog
krokiet_info_title = अधिसूचना: यह सुविधा अब उपयोग के लिए अनुशंसित नहीं है
...
main_tree_view_column_fps = एफपीएस (FPS)
...
about_other_apps_mykrut_desc = एक सरल, तेज़ और विशिष्ट विशेषताओं वाला लिनक्स फाइल मैनेजर।.
...
header_krokiet_button_tooltip = एक बार क्रोकिएट को जरूर आजमाएं - यह नया और बेहतर संस्करण है!
# Krokiet promo dialog
krokiet_promo_title = मिलिए क्रोकिएट से!
...
krokiet_promo_link_download = क्रोकीट/सेडिनिया डाउनलोड करें।
