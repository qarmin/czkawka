...
# Krokiet info dialog
krokiet_info_title = Ανακοίνωση Αφαίρεσης
krokiet_info_message =
    ...
    Τα περισσότερα χαρακτηριστικά από Czkawka GTK είναι διαθέσιμα στο Krokiet, συνήθως σε απλούστερη, ταχύτερη και πιο σταθερή μορφή. Ο Krokiet προσθέτει επίσης νέα χαρακτηριστικά και βελτιώσεις που δεν ήταν δυνατές στην έκδοση GTK.
...
image_geometric_invariance_tooltip = Συγκρίνετε επίσης mirrored/flipped και optionally rotated παραλλαγές κάθε εικόνας. Αυτό βελτιώνει το ταίριασμα, αλλά αυξάνει το χρόνο hashing.
...
main_label_geometric_invariance = Γεωμετρικό σιδηρόδρομο
...
krokiet_promo_message =
    ...
    Η Δύναμη είναι σαφώς μαζί σας, αλλά το Krokiet δεν είναι - ένα νεότερο, γρηγορότερο, ελαφρύτερο, και σημαντικά πιο όμορφος (υποθέτοντας ότι οι εφαρμογές μπορούν πραγματικά να είναι χειροπιαστές) διπλότυπο καθαριστικό.
    
    Krokiet περιλαμβάνει όλα όσα τους άρεσε η Czkawka. Είναι εντελώς δωρεάν, ανοικτού κώδικα, έχει ένα μοναδικό και απλό UI (και οι δύο επαινέθηκαν και μίσησαν από πολλούς), εισάγει πολλά νέα χαρακτηριστικά, χρησιμοποιεί λιγότερες εξαρτήσεις και λειτουργεί πολύ πιο αξιόπιστα σε διαφορετικές πλατφόρμες.
    
    Και αν με κάποιο τρόπο το χάσετε, υπάρχει ήδη μια ακόμα νεότερη εφαρμογή από το Krokiet - Cedinia, σχεδιασμένο κυρίως για συσκευές Android και χρήση οθόνης αφής.
    
    Czkawka GTK μας υπηρέτησε καλά, αλλά το ρολόι του τελείωσε.
