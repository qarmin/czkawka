...
popover_select_one_oldest_same_size = Выбрать один старый (одинаковый размер)
popover_select_one_newest_same_size = Выбрать один новый (одинаковый размер)
popover_mark_same_size = Пометить группы с одинаковым размером
popover_select_one_oldest_same_path = Выбрать один старый (одинаковый путь)
popover_select_one_newest_same_path = Выбрать один новый (одинаковый путь)
popover_select_one_oldest_longest_path = Выбрать один старый (длинный путь)
popover_select_one_newest_longest_path = Выбрать один новый (длинный путь)
popover_select_one_oldest_shortest_path = Выбрать один старый (короткий путь)
popover_select_one_newest_shortest_path = Выбрать один новый (короткий путь)
...
select_dialog_title = Выборка
select_dialog_action = Действие
select_dialog_action_all_except = Выделить все, кроме...
select_dialog_action_one = Выделить один...
select_dialog_action_select_all = Выделить все
select_dialog_action_unselect_all = Снять все выделения
select_dialog_action_reverse = Инвертировать выбор
select_dialog_action_mark_same_size = Отметить группы с одинаковым размером
select_dialog_action_custom_select = Настраиваемый выбор
select_dialog_action_custom_unselect = Настраиваемый сброс
select_dialog_criterion = Критерий
select_dialog_criterion_date = Дата
select_dialog_criterion_path = Длина пути
select_dialog_criterion_size = Размер
select_dialog_direction = Направление
select_dialog_direction_oldest = Самый старый
select_dialog_direction_newest = Самый новый
select_dialog_direction_shortest = Самый короткий
select_dialog_direction_longest = Самый длинный
select_dialog_direction_smallest = Наименьший
select_dialog_direction_biggest = Наибольший
select_dialog_path_filter = Фильтр пути
select_dialog_path_filter_any = Любой
select_dialog_path_filter_longest = Только длинный
select_dialog_path_filter_shortest = Только короткий
select_dialog_conditions = Условия
select_dialog_cond_none = Нет
select_dialog_cond_same_size = Только одинаковый размер
select_dialog_cond_same_path = Только одинаковый путь
select_dialog_custom = Настраиваемый фильтр
