...
fn progress_default(gui_data: &GuiData, item: &ProgressData) {
    ...
    match item.sstage {
        ...
        CurrentStage::DuplicateHidingHardLinks | CurrentStage::SimilarImagesHidingHardLinks | CurrentStage::SimilarVideosHidingHardLinks =>            label_stage.set_text(&flg!("progress_hiding_hard_link", progress_ratio_tm(item))),
